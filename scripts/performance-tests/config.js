...
module.exports = {
  ...
  scenarios: {
    ...
    inventory: [
      ...
      },
      {
        name: "Update Stock",
        weight: 10,
        endpoint: "/api/inventory/stock-levels/:id",
        method: "PUT",
      },
    ],
    ...
    marketplaces: [
      { name: "List Marketplaces", weight: 20, endpoint: "/api/marketplaces" },
      {
        ...
        weight: 15,
        endpoint: "/api/marketplaces/:id",
      },
      {
        name: "Sync Marketplace",
        weight: 5,
        endpoint: "/api/marketplaces/:id/sync",
        method: "POST",
      },
    ],
    ...
    insights: [
      {
        name: "List Insights",
        weight: 30,
        endpoint: "/api/ai-insights/insights",
      },
      {
        name: "Get Insight",
        weight: 20,
        endpoint: "/api/ai-insights/insights/:id",
      },
      {
        name: "Generate Insights",
        weight: 5,
        endpoint: "/api/ai-insights/generate-insights",
        method: "POST",
      },
    ...
    ragRetrieval: [
      {
        ...
        weight: 40,
        endpoint: "/api/rag-retrieval/search",
        method: "POST",
      },
      {
        name: "Get Document",
        weight: 30,
        endpoint: "/api/rag-retrieval/documents/:id",
      },
      {
        name: "List Documents",
        weight: 30,
        endpoint: "/api/rag-retrieval/documents",
      },
    ],
  },
  ...
  specialTests: {
    ...
    batchOperations: {
      createBulkProducts: {
        endpoint: "/api/inventory/products/batch",
        method: "POST",
        batchSize: 100,
      },
      updateBulkStockLevels: {
        endpoint: "/api/inventory/stock-levels/batch",
        method: "PUT",
        batchSize: 200,
      },
    },
    ...
    aiOperations: {
      vectorSearch: {
        endpoint: "/api/rag-retrieval/vector-search",
        method: "POST",
      },
      generateLargeInsight: {
        endpoint: "/api/ai-insights/generate-insights",
        method: "POST",
        dataSize: "large",
      },
