...
program
  ...
  .option('--parent-size <size>', 'Parent product count (small, medium, large)', 'small')
  .option('--variant-complexity <size>', 'Variant complexity (simple, medium, complex)', 'medium')
  .option('--network <network>', 'Network condition (excellent, good, fair, poor, critical)', 'good')
...
async function generateTestData(parentCount, variantComplexity) {
  console.log(chalk.cyan(`Generating test data for parent count: ${parentCount}, complexity: ${variantComplexity.attributes.join(', ')}`));
  ...
  for (let i = 0; i < parentCount; i++) {
    ...
    for (let j = 0; j < combinations.length; j++) {
      ...
      const skuSuffix = combination.map(attr => `${attr.code}-${attr.value}`).join('-');
...
function generateCombinations(attributes) {
  ...
  if (attributes.length === 1) {
    ...
    if (attr.validation?.options) {
      return attr.validation.options.map(option => [
        { code: attr.code, value: option, label: `${attr.label}: ${option}`, type: attr.type }
      ]);
    }
    return [[{ code: attr.code, value: attr.value, label: attr.label, type: attr.type }]];
  }
  ...
  if (firstAttr.validation?.options) {
    firstOptions = firstAttr.validation.options.map(option => (
      { code: firstAttr.code, value: option, label: `${firstAttr.label}: ${option}`, type: firstAttr.type }
    ));
  } else {
    firstOptions = [{ code: firstAttr.code, value: firstAttr.value, label: firstAttr.label, type: firstAttr.type }];
  }
 ...
 */
function createVariantService(parents = [], variants = [], networkSimulator, loadSheddingSimulator) {
  ...
  const regularVariantService = {
    ...
    async generateVariants(tenantId, productId, attributeCodes) {
      ...
      const parent = parents.find(p => p.id === productId && p.tenantId === tenantId);
      if (!parent) {
      ...
      performance.measure('Regular Generate Variants', 'regular-generate-start', 'regular-generate-end');
    ...
    async findByParentId(tenantId, parentId) {
      ...
      const result = variants.filter(v => 
        v.tenantId === tenantId && v.parentId === parentId
      );
      
      performance.mark('regular-find-parent-end');
      performance.measure('Regular Find by Parent', 'regular-find-parent-start', 'regular-find-parent-end');
    ...
    async updatePosition(tenantId, positions) {
      ...
      for (const pos of positions) {
        const variant = variants.find(v => 
          v.tenantId === tenantId && v.id === pos.variantId
        );
      ...
      performance.measure('Regular Update Position', 'regular-update-position-start', 'regular-update-position-end');
    ...
    async updateStock(tenantId, variantId, stockData) {
      ...
      const variant = variants.find(v => 
        v.tenantId === tenantId && v.id === variantId
      );
      ...
      performance.measure('Regular Update Stock', 'regular-update-stock-start', 'regular-update-stock-end');
    ...
    async updatePricing(tenantId, variantId, pricingData) {
      ...
      performance.measure('Regular Update Pricing', 'regular-update-pricing-start', 'regular-update-pricing-end');
    ...
    async deleteVariant(tenantId, variantId) {
      ...
      performance.measure('Regular Delete Variant', 'regular-delete-start', 'regular-delete-end');
    ...
    async findByAttributeValue(tenantId, attributeCode, attributeValue) {
      ...
      performance.measure('Regular Find by Attribute', 'regular-find-attribute-start', 'regular-find-attribute-end');
  ...
  const optimizedVariantService = {
    ...
    async generateVariantsOptimized(tenantId, productId, attributeCodes) {
      ...
      performance.measure('Optimized Generate Variants', 'optimized-generate-start', 'optimized-generate-end');
    ...
    async findByParentIdOptimized(tenantId, parentId) {
      ...
      if (cached) {
        ...
        performance.measure('Optimized Find by Parent (Cached)', 'optimized-find-parent-start', 'optimized-find-parent-end');
      ...
      performance.mark('optimized-find-parent-end');
      performance.measure('Optimized Find by Parent', 'optimized-find-parent-start', 'optimized-find-parent-end');
    ...
    async updatePositionsOptimized(tenantId, positions) {
      ...
      performance.measure('Optimized Update Position', 'optimized-update-position-start', 'optimized-update-position-end');
    ...
    async updateStockOptimized(tenantId, variantId, stockData) {
      ...
      performance.measure('Optimized Update Stock', 'optimized-update-stock-start', 'optimized-update-stock-end');
    ...
    async updatePricingOptimized(tenantId, variantId, pricingData) {
      ...
      performance.measure('Optimized Update Pricing', 'optimized-update-pricing-start', 'optimized-update-pricing-end');
    ...
    async deleteVariantOptimized(tenantId, variantId) {
      ...
      performance.measure('Optimized Delete Variant', 'optimized-delete-start', 'optimized-delete-end');
    ...
    async findByAttributeValueOptimized(tenantId, attributeCode, attributeValue) {
      ...
      if (cached) {
        ...
        performance.measure('Optimized Find by Attribute (Cached)', 'optimized-find-attribute-start', 'optimized-find-attribute-end');
      ...
      performance.mark('optimized-find-attribute-end');
      performance.measure('Optimized Find by Attribute', 'optimized-find-attribute-start', 'optimized-find-attribute-end');
  ...
  const saOptimizedService = {
      ...
      executeWithResilience: async (operation, opName, options) => {
        ...
        if (priority === 'high') {
          try {
            ...
            performance.measure('SA Resilience (High Priority)', 'sa-resilience-start', 'sa-resilience-end');
            return result;
          } catch (error) {
            throw error;
          }
        ...
        if (priority === 'medium') {
          ...
          try {
            const result = await operation();
            performance.mark('sa-resilience-end');
            performance.measure('SA Resilience (Medium Priority)', 'sa-resilience-start', 'sa-resilience-end');
            return result;
          } catch (error) {
            throw error;
          }
        ...
        if (priority === 'low') {
          ...
          try {
            const result = await operation();
            performance.mark('sa-resilience-end');
            performance.measure('SA Resilience (Low Priority)', 'sa-resilience-start', 'sa-resilience-end');
            return result;
          } catch (error) {
            throw error;
          }
        ...
        try {
          const result = await operation();
          performance.mark('sa-resilience-end');
          performance.measure('SA Resilience (Default)', 'sa-resilience-start', 'sa-resilience-end');
          return result;
        } catch (error) {
          throw error;
        }
    ...
    networkAwareStorage: {
      getNetworkQuality: () => {
        return {
          connectionType: 'wifi',
          connectionQuality: options.network === 'excellent' || options.network === 'good' ? 'high' : 
                             options.network === 'fair' ? 'medium' : 'low',
      ...
      optimizeOperation: (operationType) => {
        ...
        switch (networkQuality.connectionQuality) {
          case 'high':
            return { batchSize: 100, useCompression: false, minimalFields: false };
          case 'medium':
            return { batchSize: 25, useCompression: true, minimalFields: false };
          case 'low':
            return { batchSize: 10, useCompression: true, minimalFields: true };
          default:
            return { batchSize: 25, useCompression: false, minimalFields: false };
        }
      }
    },
    ...
    async generateVariantsSA(tenantId, productId, attributeCodes) {
      ...
      const networkSettings = this.networkAwareStorage.optimizeOperation('generate');
      ...
      try {
        const result = await this.loadSheddingService.executeWithResilience(
          async () => {
            ...
            const optimizedAttributeCodes = networkSettings.minimalFields && attributeCodes.length > 2
        ...
        performance.measure('SA Generate Variants', 'sa-generate-start', 'sa-generate-end');
    ...
    async findByParentIdSA(tenantId, parentId) {
      ...
      // Check network conditions
      const networkSettings = this.networkAwareStorage.optimizeOperation('find');
      
      // Execute with load shedding resilience
      try {
        const result = await this.loadSheddingService.executeWithResilience(
          async () => {
            return this.variantService.findByParentIdOptimized(tenantId, parentId);
          },
          'find-by-parent',
        ...
        performance.measure('SA Find by Parent', 'sa-find-parent-start', 'sa-find-parent-end');
    ...
    async updatePositionsSA(tenantId, positions) {
      ...
      // Check network conditions
      const networkSettings = this.networkAwareStorage.optimizeOperation('update');
      ...
      try {
        const result = await this.loadSheddingService.executeWithResilience(
          async () => {
            return this.variantService.updatePositionsOptimized(tenantId, batchedPositions);
          },
          'update-positions',
          { priority: 'medium' }
        );
        ...
        performance.measure('SA Update Positions', 'sa-update-position-start', 'sa-update-position-end');
    ...
    async updateStockSA(tenantId, variantId, stockData) {
      ...
      try {
        const result = await this.loadSheddingService.executeWithResilience(
          async () => {
            return this.variantService.updateStockOptimized(tenantId, variantId, stockData);
          },
          'update-stock',
        ...
        performance.measure('SA Update Stock', 'sa-update-stock-start', 'sa-update-stock-end');
    ...
    async updatePricingSA(tenantId, variantId, pricingData) {
      ...
      try {
        const result = await this.loadSheddingService.executeWithResilience(
          async () => {
            return this.variantService.updatePricingOptimized(tenantId, variantId, pricingData);
          },
          'update-pricing',
          { priority: 'medium' }
        );
        ...
        performance.measure('SA Update Pricing', 'sa-update-pricing-start', 'sa-update-pricing-end');
    ...
    async deleteVariantSA(tenantId, variantId) {
      ...
      try {
        const result = await this.loadSheddingService.executeWithResilience(
          async () => {
            return this.variantService.deleteVariantOptimized(tenantId, variantId);
          },
          'delete-variant',
        ...
        performance.measure('SA Delete Variant', 'sa-delete-start', 'sa-delete-end');
    ...
    async findByAttributeValueSA(tenantId, attributeCode, attributeValue) {
      ...
      try {
        const result = await this.loadSheddingService.executeWithResilience(
          async () => {
            return this.variantService.findByAttributeValueOptimized(tenantId, attributeCode, attributeValue);
          },
          'find-by-attribute',
          { priority: 'medium' }
        );
        ...
        performance.measure('SA Find by Attribute', 'sa-find-attribute-start', 'sa-find-attribute-end');
...
async function runTest(
  ...
  const { regularVariantService, optimizedVariantService, saOptimizedService } = services;
  ...
  switch (testCase.type) {
    case 'generate':
      ...
      if (parents.length > 0) {
        ...
        console.warn(chalk.yellow('No parent products found for variant generation test'));
        return null;
      }
      break;
    ...
    case 'findByParent':
      ...
      if (parents.length > 0) {
        ...
        console.warn(chalk.yellow('No parent products found for find by parent test'));
        return null;
      }
      break;
    ...
    case 'updatePosition':
      ...
      if (variants.length >= 3) {
        ...
        console.warn(chalk.yellow('Not enough variants for update position test'));
        return null;
      }
      break;
    ...
    case 'findByAttribute':
      ...
      if (variants.length > 0 && variants[0].attributes.length > 0) {
        const randomVariant = variants[Math.floor(Math.random() * variants.length)];
        const randomAttr = randomVariant.attributes[Math.floor(Math.random() * randomVariant.attributes.length)];
        testParams = {
          attributeCode: randomAttr.code,
          attributeValue: randomAttr.value
        };
      } else {
        console.warn(chalk.yellow('No variants with attributes found for find by attribute test'));
        return null;
      }
      break;
  ...
  for (let i = 0; i < numRuns; i++) {
    ...
    try {
      ...
      switch (testCase.type) {
        case 'generate':
          await regularVariantService.generateVariants(tenantId, testParams.productId, testParams.attributeCodes);
          break;
        case 'findByParent':
          await regularVariantService.findByParentId(tenantId, testParams.parentId);
          break;
        case 'updatePosition':
          await regularVariantService.updatePosition(tenantId, testParams.positions);
          break;
        case 'updateStock':
          await regularVariantService.updateStock(tenantId, testParams.variantId, testParams.stockData);
          break;
        case 'updatePricing':
          await regularVariantService.updatePricing(tenantId, testParams.variantId, testParams.pricingData);
          break;
        case 'deleteVariant':
          await regularVariantService.deleteVariant(tenantId, testParams.variantId);
          break;
        case 'findByAttribute':
          await regularVariantService.findByAttributeValue(tenantId, testParams.attributeCode, testParams.attributeValue);
          break;
      }
      ...
      console.error(chalk.red(`Regular service error (${testCase.name}): ${error.message}`));
    ...
    try {
      ...
      switch (testCase.type) {
        case 'generate':
          await optimizedVariantService.generateVariantsOptimized(tenantId, testParams.productId, testParams.attributeCodes);
          break;
        case 'findByParent':
          await optimizedVariantService.findByParentIdOptimized(tenantId, testParams.parentId);
          break;
        case 'updatePosition':
          await optimizedVariantService.updatePositionsOptimized(tenantId, testParams.positions);
          break;
        case 'updateStock':
          await optimizedVariantService.updateStockOptimized(tenantId, testParams.variantId, testParams.stockData);
          break;
        case 'updatePricing':
          await optimizedVariantService.updatePricingOptimized(tenantId, testParams.variantId, testParams.pricingData);
          break;
        case 'deleteVariant':
          await optimizedVariantService.deleteVariantOptimized(tenantId, testParams.variantId);
          break;
        case 'findByAttribute':
          await optimizedVariantService.findByAttributeValueOptimized(tenantId, testParams.attributeCode, testParams.attributeValue);
          break;
      }
      ...
      console.error(chalk.red(`Optimized service error (${testCase.name}): ${error.message}`));
    ...
    try {
      ...
      switch (testCase.type) {
        case 'generate':
          await saOptimizedService.generateVariantsSA(tenantId, testParams.productId, testParams.attributeCodes);
          break;
        case 'findByParent':
          await saOptimizedService.findByParentIdSA(tenantId, testParams.parentId);
          break;
        case 'updatePosition':
          await saOptimizedService.updatePositionsSA(tenantId, testParams.positions);
          break;
        case 'updateStock':
          await saOptimizedService.updateStockSA(tenantId, testParams.variantId, testParams.stockData);
          break;
        case 'updatePricing':
          await saOptimizedService.updatePricingSA(tenantId, testParams.variantId, testParams.pricingData);
          break;
        case 'deleteVariant':
          await saOptimizedService.deleteVariantSA(tenantId, testParams.variantId);
          break;
        case 'findByAttribute':
          await saOptimizedService.findByAttributeValueSA(tenantId, testParams.attributeCode, testParams.attributeValue);
          break;
      }
      
      performance.mark('sa-end');
      performance.measure(`Run ${i+1} SA Optimized`, 'sa-start', 'sa-end');
      const measure = performance.getEntriesByName(`Run ${i+1} SA Optimized`)[0];
      results.saOptimized.runs.push(measure.duration);
    } catch (error) {
      console.error(chalk.red(`SA Optimized service error (${testCase.name}): ${error.message}`));
  ...
  if (saOptimizedValid.length > 0) {
    results.saOptimized.avg = saOptimizedValid.reduce((a, b) => a + b, 0) / saOptimizedValid.length;
  ...
  if (results.regular.avg > 0 && results.optimized.avg > 0) {
    results.baseImprovement = ((results.regular.avg - results.optimized.avg) / results.regular.avg) * 100;
  }
  
  if (results.regular.avg > 0 && results.saOptimized.avg > 0) {
    results.saImprovement = ((results.regular.avg - results.saOptimized.avg) / results.regular.avg) * 100;
  }
...
async function runBenchmarks() {
  ...
  console.log(chalk.blue(`Parent Products: ${options.parentSize} (${CONFIG.parentProductSizes[options.parentSize]} products)`));
  console.log(chalk.blue(`Variant Complexity: ${options.variantComplexity} (${CONFIG.variantComplexity[options.variantComplexity].attributeCombinations} combinations)`));
  ...
  // Generate test data
  const parentCount = CONFIG.parentProductSizes[options.parentSize] || CONFIG.parentProductSizes.small;
  const complexity = CONFIG.variantComplexity[options.variantComplexity] || CONFIG.variantComplexity.medium;
  const testData = await generateTestData(parentCount, complexity);
  
  // Log test data information
  console.log(chalk.yellow(`Generated ${testData.parents.length} parent products and ${testData.variants.length} variants`));
  ...
  const services = createVariantService(testData.parents, testData.variants, networkSimulator, loadSheddingSimulator);
...
async function generateReport(results) {
  ...
  const summary = {
    ...
    variantCombinations: CONFIG.variantComplexity[options.variantComplexity].attributeCombinations,
  ...
  const baseImprovements = results.map(r => r.baseImprovement).filter(i => !isNaN(i));
  
  if (baseImprovements.length > 0) {
    summary.summary.averageBaseImprovement = baseImprovements.reduce((a, b) => a + b, 0) / baseImprovements.length;
  ...
  const saImprovements = results.map(r => r.saImprovement).filter(i => !isNaN(i));
  
  if (saImprovements.length > 0) {
    summary.summary.averageSAImprovement = saImprovements.reduce((a, b) => a + b, 0) / saImprovements.length;
    summary.summary.minSAImprovement = Math.min(...saImprovements);
    summary.summary.maxSAImprovement = Math.max(...saImprovements);
    
    summary.summary.operationsWithImprovementOver50Percent = saImprovements.filter(i => i >= 50).length;
    summary.summary.operationsWithImprovementUnder20Percent = saImprovements.filter(i => i < 20).length;
  }
  ...
  if (options.network === 'excellent' || options.network === 'good') {
    ...
    summary.summary.networkImpact = 'Significant impact from poor network conditions';
  }
  ...
  if (options.loadShedding === '0') {
    ...
    summary.summary.loadSheddingImpact = 'Severe impact from high-stage load shedding';
  }
...
${results
  ...
  .map((r, i) => `${i+1}. ${r.name} (${r.type}): ${r.saImprovement.toFixed(2)}% improvement`)
  .join('\n')}
...
SA Improvement: ${r.saImprovement.toFixed(2)}%`).join('\n')}
...
4. ${options.network !== 'excellent' && options.network !== 'good'
...
5. ${options.loadShedding !== '0'
  ...
  // Print key findings
  console.log(chalk.bold.green('\nKey Findings:'));
  console.log(chalk.cyan(`Average Base Improvement: ${summary.summary.averageBaseImprovement.toFixed(2)}%`));
  console.log(chalk.cyan(`Average SA-Optimized Improvement: ${summary.summary.averageSAImprovement.toFixed(2)}%`));
  console.log(chalk.cyan(`Best Operation: ${summary.summary.bestOperationType} (${summary.summary.maxSAImprovement.toFixed(2)}% improvement)`));
  console.log(chalk.cyan(`Worst Operation: ${summary.summary.worstOperationType} (${summary.summary.minSAImprovement.toFixed(2)}% improvement)`));
