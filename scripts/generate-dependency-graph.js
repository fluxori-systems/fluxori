    ...
    outputs: [
      {
        ...
        focus: "^src/modules/",
        output: "backend/module-dependencies.dot",
      },
      {
        name: "full-graph",
        include: "^src",
        output: "backend/dependency-graph.dot",
      },
    ],
  },
  {
    ...
    outputs: [
      {
        name: "module-dependencies",
        focus: "^src/lib/(ui|motion|shared)/",
        output: "frontend/module-dependencies.dot",
      },
      {
        name: "component-graph",
        include: "^src/components",
        output: "frontend/component-dependencies.dot",
      },
    ],
  },
];
  ...
  for (const path of paths) {
    ...
    for (const output of path.outputs) {
      try {
        ...
        console.error(
          `Error generating ${output.name} for ${path.name}:`,
          error,
        );
      }
    }
