...
describe('Smoke Tests', () => {
  ...
  describe('Database', () => {
    ...
    beforeAll(async () => {
      if (config.auth.email && config.auth.password && !testUtils.api.defaults.headers.common['Authorization']) {
    ...
    it('can write and read a test document', async () => {
      ...
      expect(readResponse.data).toHaveProperty('description', testData.description);
