...
var FirestoreConfigService = function () {
    ...
    var FirestoreConfigService = _classThis = /** @class */ (function () {
        function FirestoreConfigService_1(configService) {
            ...
            var databaseId = this.configService.get("FIRESTORE_DATABASE_ID", "fluxori-db");
            this.collectionPrefix = this.configService.get("FIRESTORE_COLLECTION_PREFIX", "");
            ...
            this.logger.log("Initialized Firestore connection to project ".concat(this.projectId, ", database ").concat(databaseId, ", region ").concat(this.region));
        }
        /**
         ...
         */
        FirestoreConfigService_1.prototype.getCollection = function (collectionName) {
         ...
         */
        FirestoreConfigService_1.prototype.getDocument = function (collectionName, documentId) {
         ...
         */
        FirestoreConfigService_1.prototype.getCollectionName = function (collectionName) {
