...
import { IMarketplaceConnector } from '../interfaces/connector.interface';
import {
 ...
 */
export abstract class BaseMarketplaceConnector
    ...
    >
{
   ...
   */
  protected abstract getProductByIdInternal(
    productId: string,
  ): Promise<OperationResult<MarketplaceProduct>>;
   ...
   */
  protected abstract getOrdersInternal(
    options: PaginationOptions,
  ): Promise<PaginatedResponse<MarketplaceOrder>>;
   ...
   */
  protected abstract getProductBySkuInternal(
    sku: string,
  ): Promise<OperationResult<MarketplaceProduct>>;
   ...
   */
  protected abstract getProductsBySkusInternal(
    skus: string[],
  ): Promise<OperationResult<MarketplaceProduct[]>>;
   ...
   */
  protected abstract getProductsInternal(
    options: PaginationOptions,
  ): Promise<PaginatedResponse<MarketplaceProduct>>;
   ...
   */
  protected abstract getOrderByIdInternal(
    id: string,
   ...
   */
  protected abstract acknowledgeOrderInternal(
    orderId: string,
  ): Promise<OperationResult<OrderAcknowledgment>>;
   ...
   */
  protected abstract updateStockInternal(
    updates: Array<{
      sku: string;
      stockLevel: number;
      locationId?: string;
   ...
   */
  protected abstract updatePricesInternal(
    updates: Array<{
      sku: string;
      price: number;
      compareAtPrice?: number;
