...
export class AmazonSpConnector extends BaseMarketplaceConnector {
  ...
  protected async initializeInternal(credentials: ConnectorCredentials): Promise<void> {
    this.logger.log('Amazon SP connector initialized - placeholder implementation');
  ...
  protected async testConnectionInternal(): Promise<ConnectionStatus> {
    this.logger.log('Amazon SP connector test connection - placeholder implementation');
    return {
      connected: true,
