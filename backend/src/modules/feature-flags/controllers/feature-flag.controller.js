  ...
  var FeatureFlagController = (_classThis = /** @class */ (function () {
    ...
    FeatureFlagController_1.prototype.createFlag = function (flagDTO, user) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          ...
          return [
            2 /*return*/,
            this.featureFlagService.createFlag(flagDTO, user.id),
          ];
        });
      });
    };
    ...
    FeatureFlagController_1.prototype.getAllFlags = function (environment) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          this.logger.log(
            'Getting all feature flags'.concat(
              environment ? ' for environment: '.concat(environment) : '',
            ),
          );
          return [
            2 /*return*/,
            this.featureFlagService.getAllFlags(environment),
          ];
        });
      });
    };
     ...
     */
    FeatureFlagController_1.prototype.updateFlag = function (
      id,
      flagDTO,
      user,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          ...
          return [
            2 /*return*/,
            this.featureFlagService.updateFlag(id, flagDTO, user.id),
          ];
        });
      });
    };
     ...
     */
    FeatureFlagController_1.prototype.toggleFlag = function (
      id,
      toggleDTO,
      user,
    ) {
        ...
        return __generator(this, function (_a) {
          this.logger.log(
            'Toggling feature flag: '
              .concat(id, ' to ')
              .concat(toggleDTO.enabled),
          );
          return [
            2 /*return*/,
            this.featureFlagService.toggleFlag(id, toggleDTO, user.id),
          ];
        });
      });
    };
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.featureFlagService.deleteFlag(id, user.id),
              ];
            case 1:
              result = _a.sent();
     ...
     */
    FeatureFlagController_1.prototype.evaluateFlag = function (
      key,
      context,
      user,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          mergedContext = __assign(__assign({}, context), {
          ...
          return [
            2 /*return*/,
            this.featureFlagService.evaluateFlag(key, mergedContext),
          ];
        });
      });
    };
     ...
     */
    FeatureFlagController_1.prototype.isEnabled = function (
      key,
      context,
      user,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              this.logger.debug(
                'Checking if feature flag is enabled: '.concat(key),
              );
              mergedContext = __assign(__assign({}, context), {
              ...
              if (
                ...
                auth_1.AuthUtils.isInOrganization(
                  user,
                  mergedContext.organizationId,
                )
              ) {
                this.logger.debug(
                  'User belongs to evaluated organization: '.concat(
                    mergedContext.organizationId,
                  ),
                );
              }
              return [
                4 /*yield*/,
                this.featureFlagService.isEnabled(key, mergedContext),
              ];
            case 1:
              isEnabled = _a.sent();
     ...
     */
    FeatureFlagController_1.prototype.evaluateBatchFlags = function (
      data,
      user,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              this.logger.debug(
                'Evaluating batch of feature flags: '.concat(
                  data.keys.join(', '),
                ),
              );
              mergedContext = __assign(__assign({}, data.context), {
                userId: data.context.userId || user.id,
                userRole: data.context.userRole || user.role,
                organizationId:
                  data.context.organizationId || user.organizationId,
              });
              results = {};
              (_i = 0), (_a = data.keys);
              _d.label = 1;
  ...
  (function () {
    ...
    __esDecorate(
      ...
      _createFlag_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'createFlag' in obj;
          },
          get: function (obj) {
            return obj.createFlag;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _getAllFlags_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'getAllFlags' in obj;
          },
          get: function (obj) {
            return obj.getAllFlags;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _getFlagById_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'getFlagById' in obj;
          },
          get: function (obj) {
            return obj.getFlagById;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _getFlagByKey_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'getFlagByKey' in obj;
          },
          get: function (obj) {
            return obj.getFlagByKey;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _updateFlag_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'updateFlag' in obj;
          },
          get: function (obj) {
            return obj.updateFlag;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _toggleFlag_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'toggleFlag' in obj;
          },
          get: function (obj) {
            return obj.toggleFlag;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _getAuditLogs_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'getAuditLogs' in obj;
          },
          get: function (obj) {
            return obj.getAuditLogs;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _evaluateFlag_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'evaluateFlag' in obj;
          },
          get: function (obj) {
            return obj.evaluateFlag;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      _classThis,
      null,
      _evaluateBatchFlags_decorators,
      {
        kind: 'method',
        name: 'evaluateBatchFlags',
        static: false,
        private: false,
        access: {
          has: function (obj) {
            return 'evaluateBatchFlags' in obj;
          },
          get: function (obj) {
            return obj.evaluateBatchFlags;
          },
        },
        metadata: _metadata,
      },
