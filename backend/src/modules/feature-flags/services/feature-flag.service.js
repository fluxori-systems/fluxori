    ...
    var FeatureFlagService = _classThis = /** @class */ (function () {
                        ...
                        case 1:
                            ...
                            setInterval(function () {
                                _this.refreshCache().catch(function (err) {
                                    return _this.logger.error("Failed to refresh feature flag cache", err);
                                });
        ...
        FeatureFlagService_1.prototype.createFlag = function (flagDTO, userId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.featureFlagRepository.findByKey(flagDTO.key)];
                        case 1:
                            existingFlag = _a.sent();
                            if (existingFlag) {
                                throw new common_1.BadRequestException("Feature flag with key '".concat(flagDTO.key, "' already exists"));
                            }
                            // Perform additional validation based on flag type
                            this.validateFlagData(flagDTO);
                            return [4 /*yield*/, this.featureFlagRepository.create(__assign(__assign({}, flagDTO), { lastModifiedBy: userId, lastModifiedAt: firestore_1.Timestamp.now() }))];
                        case 2:
                            newFlag = _a.sent();
                            // Log the creation in the audit log
                            return [4 /*yield*/, this.auditLogRepository.create({
                                    flagId: newFlag.id,
                                    flagKey: newFlag.key,
                                    action: "created",
                                    performedBy: userId,
        ...
        FeatureFlagService_1.prototype.updateFlag = function (id, flagDTO, userId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, this.featureFlagRepository.findById(id)];
                        case 1:
                            existingFlag = _c.sent();
                            if (!existingFlag) {
                                throw new common_1.NotFoundException("Feature flag with ID '".concat(id, "' not found"));
                            }
                            // Validate the update data
                            if (flagDTO.type && flagDTO.type !== existingFlag.type) {
                                this.validateFlagData(__assign(__assign({}, existingFlag), flagDTO));
                            }
                            changes = [];
                            ...
                            return [4 /*yield*/, this.featureFlagRepository.update(id, __assign(__assign({}, flagDTO), { lastModifiedBy: userId, lastModifiedAt: firestore_1.Timestamp.now() }))];
                        case 2:
                            updatedFlag = _c.sent();
         ...
         */
        FeatureFlagService_1.prototype.toggleFlag = function (id, toggleDTO, userId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.featureFlagRepository.toggleFlag(id, toggleDTO.enabled)];
                        case 2:
                            updatedFlag = _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            flag = _a.sent();
                            if (!flag) {
                                throw new common_1.NotFoundException("Feature flag with key '".concat(key, "' not found"));
                            }
        ...
        FeatureFlagService_1.prototype.getAllFlags = function (environment) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (environment) {
                        return [2 /*return*/, this.featureFlagRepository.findByEnvironment(environment)];
                    }
        ...
        FeatureFlagService_1.prototype.evaluateFlag = function (flagKey, context) {
            return __awaiter(this, void 0, void 0, function () {
                var flag, cachedFlag, now, isWithinRecurrence, hashInput, hash, normalizedHash, isEnabled, isUserTargeted, _a, userIds, userRoles, userEmails, isOrgTargeted, _b, organizationIds, organizationTypes, error_1;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _c.trys.push([0, 3, , 4]);
                            ...
                            return [4 /*yield*/, this.featureFlagRepository.findByKey(flagKey)];
                        case 1:
                            flag = _c.sent();
                            if (flag) {
                        ...
                        case 2:
                            ...
                            if (flag.type === types_1.FeatureFlagType.SCHEDULED && flag.schedule) {
                                now = context.currentDate || new Date();
                                // Check date range
                                if (flag.schedule.startDate &&
                                ...
                                if (flag.schedule.recurrence) {
                                    isWithinRecurrence = this.checkRecurrenceSchedule(now, flag.schedule);
                            ...
                            switch (flag.type) {
                                ...
                                case types_1.FeatureFlagType.PERCENTAGE:
                                    ...
                                    return [2 /*return*/, {
                                            ...
                                            source: "evaluation",
                                            timestamp: new Date(),
                                            reason: "Percentage rollout: ".concat(normalizedHash, "% (threshold: ").concat(flag.percentage, "%)"),
                                        }];
                                case types_1.FeatureFlagType.USER_TARGETED:
                                    ...
                                    _a = flag.userTargeting, userIds = _a.userIds, userRoles = _a.userRoles, userEmails = _a.userEmails;
                                ...
                                case types_1.FeatureFlagType.ORGANIZATION_TARGETED:
                                    ...
                                    isOrgTargeted = false;
                                    _b = flag.organizationTargeting, organizationIds = _b.organizationIds, organizationTypes = _b.organizationTypes;
                        ...
                        case 3:
                            error_1 = _c.sent();
                            this.logger.error("Error evaluating flag ".concat(flagKey, ":"), error_1);
                            return [2 /*return*/, {
                                    flagKey: flagKey,
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_2 = _a.sent();
                            this.logger.error("Error checking if flag ".concat(flagKey, " is enabled:"), error_2);
         ...
         */
        FeatureFlagService_1.prototype.removeFlagChangeListener = function (callback) {
        ...
        FeatureFlagService_1.prototype.validateFlagData = function (flagDTO) {
            ...
            if (!/^[a-z0-9-]+$/.test(flagDTO.key)) {
                throw new common_1.BadRequestException("Flag key must be lowercase alphanumeric with hyphens only");
            }
            // Type-specific validation
            switch (flagDTO.type) {
                case types_1.FeatureFlagType.PERCENTAGE:
                    if (flagDTO.percentage === undefined ||
                        flagDTO.percentage < 0 ||
                        flagDTO.percentage > 100) {
                        throw new common_1.BadRequestException("Percentage flags require a percentage value between 0-100");
                    }
                    break;
                case types_1.FeatureFlagType.USER_TARGETED:
                    if (!flagDTO.userTargeting ||
                        (!flagDTO.userTargeting.userIds &&
                            !flagDTO.userTargeting.userRoles &&
                            !flagDTO.userTargeting.userEmails)) {
                        throw new common_1.BadRequestException("User-targeted flags require user targeting configuration");
                    }
                    break;
                case types_1.FeatureFlagType.ORGANIZATION_TARGETED:
                    if (!flagDTO.organizationTargeting ||
                        (!flagDTO.organizationTargeting.organizationIds &&
                            !flagDTO.organizationTargeting.organizationTypes)) {
                        throw new common_1.BadRequestException("Organization-targeted flags require organization targeting configuration");
                    }
                    break;
                case types_1.FeatureFlagType.SCHEDULED:
                    if (!flagDTO.schedule ||
                        ...
                        throw new common_1.BadRequestException("Scheduled flags require schedule configuration");
                    }
                    break;
            }
        };
         ...
         */
        FeatureFlagService_1.prototype.checkRecurrenceSchedule = function (now, schedule) {
            ...
            if (schedule.recurrence.timeRanges &&
                ...
                return schedule.recurrence.timeRanges.some(function (range) {
                    var _a = range.startTime.split(":").map(Number), startHour = _a[0], startMinute = _a[1];
                    var _b = range.endTime.split(":").map(Number), endHour = _b[0], endMinute = _b[1];
                    var startTimeMinutes = startHour * 60 + startMinute;
                    var endTimeMinutes = endHour * 60 + endMinute;
                    return (currentTimeMinutes_1 >= startTimeMinutes &&
         ...
         */
        FeatureFlagService_1.prototype.notifyFlagChange = function (flagKey, isEnabled) {
            var _this = this;
         ...
         */
        FeatureFlagService_1.prototype.evaluateFlagsForSubscription = function (subscription) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            flagKey = _a[_i];
                            return [4 /*yield*/, this.evaluateFlag(flagKey, subscription.evaluationContext || {})];
                        case 2:
                            evaluation = _b.sent();
                        ...
                        case 5:
                            error_3 = _b.sent();
                            this.logger.error("Error evaluating flags for subscription:", error_3);
                            return [3 /*break*/, 6];
