...
var FeatureFlagCacheService = function () {
    ...
    var FeatureFlagCacheService = _classThis = /** @class */ (function () {
         ...
         */
        FeatureFlagCacheService_1.prototype.setEvaluation = function (flagKey, context, result) {
         ...
         */
        FeatureFlagCacheService_1.prototype.getEvaluation = function (flagKey, context) {
            var cacheKey = this.createCacheKey(flagKey, context);
        ...
        FeatureFlagCacheService_1.prototype.areAllFlagsCached = function (keys) {
            var _this = this;
            return keys.every(function (key) { return _this.flagCache.has(key); });
        };
        /**
        ...
        FeatureFlagCacheService_1.prototype.getFlags = function (keys) {
            var _this = this;
            return keys
                .filter(function (key) { return _this.flagCache.has(key); })
                .map(function (key) { return _this.flagCache.get(key); })
                .filter(function (flag) { return flag !== undefined; });
        };
        /**
        ...
        FeatureFlagCacheService_1.prototype.cleanupExpiredCache = function () {
            ...
            if (expiredCount.flags > 0 || expiredCount.evaluations > 0) {
                this.logger.debug("Cleaned up ".concat(expiredCount.evaluations, " expired evaluation cache entries"));
            }
        };
        /**
         * Invalidate all evaluation cache entries for a specific flag
         */
        FeatureFlagCacheService_1.prototype.invalidateEvaluationCache = function (flagKey) {
            var _this = this;
            var keysToRemove = [];
            ...
            if (keysToRemove.length > 0) {
                this.logger.debug("Invalidated ".concat(keysToRemove.length, " evaluation cache entries for flag ").concat(flagKey));
            }
        };
        /**
         * Create a cache key from flag key and context
         */
        FeatureFlagCacheService_1.prototype.createCacheKey = function (flagKey, context) {
