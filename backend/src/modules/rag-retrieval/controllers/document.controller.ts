...
export class DocumentController {
  ...
  async findWithFilters(
    ...
    const parsedIsIndexed = isIndexed !== undefined ? String(isIndexed).toLowerCase() === 'true' : undefined;
    const parsedIsPublic = isPublic !== undefined ? String(isPublic).toLowerCase() === 'true' : undefined;
  ...
  async getPendingIndexing(
    ...
    return this.documentService.findPendingIndexing(organizationId, parsedLimit);
  }
