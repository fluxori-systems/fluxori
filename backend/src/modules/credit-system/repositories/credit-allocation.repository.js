...
var CreditAllocationRepository = function () {
    ...
    var CreditAllocationRepository = _classThis = /** @class */ (function (_super) {
        __extends(CreditAllocationRepository_1, _super);
        function CreditAllocationRepository_1(firestoreConfigService) {
            var _this = _super.call(this, firestoreConfigService, "credit_allocations", {
                useVersioning: true,
                enableCache: true,
         ...
         */
        CreditAllocationRepository_1.prototype.findActiveByOrganization = function (organizationId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            allocations = _a.sent();
                            return [2 /*return*/, allocations.length > 0 ? allocations[0] : null];
                    }
                });
            });
        };
         ...
         */
        CreditAllocationRepository_1.prototype.findByOrganization = function (organizationId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
         ...
         * @returns Active credit allocation or null if not found
         */
        CreditAllocationRepository_1.prototype.findActiveByUser = function (organizationId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var allocations;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         * @returns Array of credit allocations
         */
        CreditAllocationRepository_1.prototype.findByType = function (organizationId, modelType) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.find({
                            filter: {
         ...
         */
        CreditAllocationRepository_1.prototype.updateFields = function (id, fields) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
         ...
         */
        CreditAllocationRepository_1.prototype.decrementCredits = function (allocationId, amount) {
            return __awaiter(this, void 0, void 0, function () {
                var allocation;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findById(allocationId)];
                        case 1:
                            allocation = _a.sent();
                            if (!allocation) {
                            ...
                            if (allocation.remainingCredits < amount) {
                                throw new Error("Insufficient credits in allocation: ".concat(allocationId));
                            }
                            return [2 /*return*/, this.updateFields(allocationId, {
         ...
         * @returns Updated allocation
         */
        CreditAllocationRepository_1.prototype.addCredits = function (allocationId, amount) {
            return __awaiter(this, void 0, void 0, function () {
                var allocation;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         * @returns Updated allocation
         */
        CreditAllocationRepository_1.prototype.deactivate = function (allocationId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.updateFields(allocationId, {
                            isActive: false,
