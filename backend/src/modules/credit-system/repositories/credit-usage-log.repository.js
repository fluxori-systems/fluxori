...
exports.CreditUsageLogRepository = void 0;
 ...
 */
var CreditUsageLogRepository = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = firestore_base_repository_1.FirestoreBaseRepository;
    var CreditUsageLogRepository = _classThis = /** @class */ (function (_super) {
        __extends(CreditUsageLogRepository_1, _super);
        function CreditUsageLogRepository_1(firestoreConfigService) {
            var _this = _super.call(this, firestoreConfigService, "credit_usage_logs", {
                useVersioning: true,
                enableCache: false, // Logs are append-only, no need to cache
                requiredFields: ["organizationId", "usageType", "creditsUsed", "success"],
            }) || this;
            _this.collectionName = "credit_usage_logs";
            return _this;
        }
        /**
         ...
         */
        CreditUsageLogRepository_1.prototype.findByOrganization = function (organizationId, limit) {
         ...
         * @returns Array of usage logs
         */
        CreditUsageLogRepository_1.prototype.findByUser = function (organizationId, userId, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.find({
                            filter: {
         ...
         * @returns Array of usage logs
         */
        CreditUsageLogRepository_1.prototype.findByModel = function (organizationId, modelId, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.find({
                            filter: {
         ...
         * @returns Array of usage logs
         */
        CreditUsageLogRepository_1.prototype.findByUsageType = function (organizationId, usageType, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.find({
                            filter: {
         ...
         */
        CreditUsageLogRepository_1.prototype.getUsageStats = function (organizationId, startDate, endDate) {
            return __awaiter(this, void 0, void 0, function () {
                var logs, filteredLogs, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return CreditUsageLogRepository_1;
    }(_classSuper));
    __setFunctionName(_classThis, "CreditUsageLogRepository");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        CreditUsageLogRepository = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreditUsageLogRepository = _classThis;
}();
exports.CreditUsageLogRepository = CreditUsageLogRepository;
