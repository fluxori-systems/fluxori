...
var CreditTransactionRepository = (function () {
  ...
  var CreditTransactionRepository = (_classThis = /** @class */ (function (
    _super,
  ) {
    __extends(CreditTransactionRepository_1, _super);
    function CreditTransactionRepository_1(firestoreConfigService) {
      var _this =
        _super.call(this, firestoreConfigService, 'credit_transactions', {
          useVersioning: true,
          enableCache: true,
     ...
     */
    CreditTransactionRepository_1.prototype.findByOrganization = function (
      organizationId,
      limit,
    ) {
     ...
     * @returns Array of transactions
     */
    CreditTransactionRepository_1.prototype.findByUser = function (
      organizationId,
      userId,
      limit,
    ) {
     ...
     * @returns Array of transactions
     */
    CreditTransactionRepository_1.prototype.findByUsageType = function (
      organizationId,
      usageType,
      limit,
    ) {
     ...
     * @returns Array of transactions
     */
    CreditTransactionRepository_1.prototype.findByModel = function (
      organizationId,
      modelId,
      limit,
    ) {
     ...
     */
    CreditTransactionRepository_1.prototype.getSumByType = function (
      organizationId,
      transactionType,
      usageType,
      startDate,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                2 /*return*/,
                filteredTransactions.reduce(function (sum, transaction) {
