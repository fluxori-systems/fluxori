 ...
 */
var CreditTransactionRepository = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = firestore_base_repository_1.FirestoreBaseRepository;
    var CreditTransactionRepository = _classThis = /** @class */ (function (_super) {
        __extends(CreditTransactionRepository_1, _super);
        function CreditTransactionRepository_1(firestoreConfigService) {
            var _this = _super.call(this, firestoreConfigService, "credit_transactions", {
                useVersioning: true,
                enableCache: true,
                cacheTTLMs: 2 * 60 * 1000, // 2 minutes
                requiredFields: ["organizationId", "amount", "transactionType", "usageType"],
            }) || this;
            _this.collectionName = "credit_transactions";
            return _this;
        }
        /**
         ...
         */
        CreditTransactionRepository_1.prototype.findByOrganization = function (organizationId, limit) {
         ...
         * @returns Array of transactions
         */
        CreditTransactionRepository_1.prototype.findByUser = function (organizationId, userId, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.find({
                            filter: {
         ...
         * @returns Array of transactions
         */
        CreditTransactionRepository_1.prototype.findByUsageType = function (organizationId, usageType, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.find({
                            filter: {
         ...
         * @returns Array of transactions
         */
        CreditTransactionRepository_1.prototype.findByModel = function (organizationId, modelId, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.find({
                            filter: {
         ...
         */
        CreditTransactionRepository_1.prototype.getSumByType = function (organizationId, transactionType, usageType, startDate, endDate) {
            return __awaiter(this, void 0, void 0, function () {
                var filter, transactions, filteredTransactions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            filter = {
                        ...
                        case 1:
                            ...
                            // Sum the amounts
                            return [2 /*return*/, filteredTransactions.reduce(function (sum, transaction) {
        ...
        return CreditTransactionRepository_1;
    }(_classSuper));
    __setFunctionName(_classThis, "CreditTransactionRepository");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        CreditTransactionRepository = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreditTransactionRepository = _classThis;
}();
