...
var CreditSystemService = (function () {
  ...
  var CreditSystemService = (_classThis = /** @class */ (function () {
    function CreditSystemService_1(
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              setInterval(
                function () {
                  return _this.refreshPricingCache();
                },
                30 * 60 * 1000,
              ); // Refresh pricing cache every 30 minutes
              setInterval(
                function () {
                  return _this.cleanupExpiredReservations();
                },
                5 * 60 * 1000,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              for (
                _i = 0, activeTiers_1 = activeTiers;
                _i < activeTiers_1.length;
                _i++
              ) {
                tier = activeTiers_1[_i];
                cacheKey = ''
                  .concat(tier.modelId, ':')
                  .concat(tier.modelProvider);
              ...
              this.logger.debug(
                'Refreshed pricing cache with '.concat(
                  activeTiers.length,
                  ' tiers',
                ),
              );
            ...
            case 2:
              error_1 = _a.sent();
              this.logger.error(
                'Error refreshing pricing cache: '.concat(error_1.message),
                error_1.stack,
              );
              return [3 /*break*/, 3];
            case 3:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (count > 0) {
                this.logger.log(
                  'Cleaned up '.concat(count, ' expired credit reservations'),
                );
              }
              return [3 /*break*/, 3];
            case 2:
              error_2 = _a.sent();
              this.logger.error(
                'Error cleaning up expired reservations: '.concat(
                  error_2.message,
                ),
                error_2.stack,
              );
     ...
     */
    CreditSystemService_1.prototype.createAllocation = function (
      organizationId,
      modelType,
      totalCredits,
      userId,
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              this.logger.log(
                'Creating allocation of '
                  .concat(totalCredits, ' credits for organization ')
            ...
            case 2:
              ...
              return [
                ...
                this.transactionRepository.create({
                  ...
                  metadata: __assign(
                    { allocationId: allocation.id, allocationCreated: true },
                    metadata,
                  ),
                }),
              ];
            ...
            case 4:
              error_3 = _a.sent();
              this.logger.error(
                'Error creating allocation: '.concat(error_3.message),
                error_3.stack,
              );
              throw new Error(
                'Failed to create credit allocation: '.concat(error_3.message),
              );
            case 5:
              return [2 /*return*/];
          }
     ...
     */
    CreditSystemService_1.prototype.getActiveAllocation = function (
      organizationId,
      userId,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.allocationRepository.findActiveByUser(
                  organizationId,
                  userId,
                ),
              ];
            ...
            case 2:
              ...
              return [
                2 /*return*/,
                this.allocationRepository.findActiveByOrganization(
                  organizationId,
                ),
              ];
            case 3:
              error_4 = _a.sent();
              this.logger.error(
                'Error fetching active allocation: '.concat(error_4.message),
                error_4.stack,
              );
              throw new Error(
                'Failed to fetch active credit allocation: '.concat(
                  error_4.message,
                ),
              );
            case 4:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              featureKey = 'credit-intensive-'.concat(
                request.usageType.toLowerCase(),
              );
              return [
                4 /*yield*/,
                this.featureFlagService.isEnabled(featureKey, {
            ...
            case 4:
              ...
              return [
                4 /*yield*/,
                this.reservationRepository.getTotalReserved(
                  request.organizationId,
                ),
              ];
            case 5:
              ...
              return [
                ...
                this.reservationRepository.create({
                  ...
                  expirationDate: new Date(
                    Date.now() + this.reservationExpirationMs,
                  ),
            ...
            case 8:
              error_5 = _a.sent();
              this.logger.error(
                'Error checking credits: '.concat(error_5.message),
                error_5.stack,
              );
              // Record response time
              this.recordResponseTime(startTime);
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              return [
                4 /*yield*/,
                this.reservationRepository.findById(request.reservationId),
              ];
            case 4:
              reservation = _a.sent();
            ...
            case 9:
              error_6 = _a.sent();
              this.logger.error(
                'Error recording usage: '.concat(error_6.message),
                error_6.stack,
              );
              // Record response time
              this.recordResponseTime(startTime);
              throw new Error(
                'Failed to record credit usage: '.concat(error_6.message),
              );
            case 10:
              return [2 /*return*/];
          }
     ...
     */
    CreditSystemService_1.prototype.calculateCost = function (
      modelId,
      inputTokens,
      outputTokens,
    ) {
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              cacheKey = ''
                .concat(modelId, ':')
                .concat(
                  modelInfo === null || modelInfo === void 0
                    ? void 0
                    : modelInfo.provider,
                );
              if (this.modelPricingCache.has(cacheKey)) {
                ...
                if (pricing) {
                  ...
                  return [
                    2 /*return*/,
                    Math.max(1, Math.ceil(inputCost + outputCost)),
                  ];
                }
              }
              this.cacheMissCount++;
              ...
              return [
                4 /*yield*/,
                this.pricingRepository.findActiveForModel(
                  modelId,
                  modelInfo.provider,
                ),
              ];
            ...
            case 4:
              error_7 = _a.sent();
              this.logger.error(
                'Error calculating cost: '.concat(error_7.message),
                error_7.stack,
              );
              // Fallback to a safe default
              return [
                2 /*return*/,
                Math.max(1, Math.ceil((inputTokens + outputTokens) / 1000)),
              ];
            case 5:
              return [2 /*return*/];
          }
     ...
     */
    CreditSystemService_1.prototype.getModelInfoForPricing = function (
      modelId,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              allModels = _a.sent();
              model = allModels.find(function (m) {
            ...
            case 2:
              error_8 = _a.sent();
              this.logger.error(
                'Error getting model info: '.concat(error_8.message),
                error_8.stack,
              );
              return [2 /*return*/, null];
            case 3:
     ...
     */
    CreditSystemService_1.prototype.deductCredits = function (
      organizationId,
      amount,
      usageType,
      userId,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                this.getActiveAllocation(organizationId, userId),
              ];
            case 1:
              allocation = _a.sent();
              if (!allocation) {
                throw new Error(
                  'No active credit allocation found for organization '.concat(
                    organizationId,
                  ),
                );
              }
              if (allocation.remainingCredits < amount) {
                throw new Error(
                  'Insufficient credits: Required '
                    .concat(amount, ', Available ')
                    .concat(allocation.remainingCredits),
                );
              }
            ...
            case 2:
              ...
              return [
                2 /*return*/,
                this.allocationRepository.decrementCredits(
                  allocation.id,
                  amount,
                ),
              ];
     ...
     * @returns Updated allocation
     */
    CreditSystemService_1.prototype.addCreditsToAllocation = function (
      allocationId,
      amount,
      userId,
      metadata,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.allocationRepository.findById(allocationId),
              ];
            case 1:
              allocation = _a.sent();
              if (!allocation) {
              ...
              return [
                ...
                this.transactionRepository.create({
                  ...
                  usageType: types_1.CreditUsageType.TOKEN_USAGE, // Default
                  metadata: __assign(
                    { allocationId: allocationId, creditAddedBy: userId },
                    metadata,
                  ),
                }),
              ];
            case 2:
              ...
              return [
                2 /*return*/,
                this.allocationRepository.addCredits(allocationId, amount),
              ];
            case 3:
              error_9 = _a.sent();
              this.logger.error(
                'Error adding credits: '.concat(error_9.message),
                error_9.stack,
              );
              throw new Error(
                'Failed to add credits: '.concat(error_9.message),
              );
            case 4:
              return [2 /*return*/];
          }
     ...
     */
    CreditSystemService_1.prototype.getRecentTransactions = function (
      organizationId_1,
    ) {
      return __awaiter(
        this,
        ...
        function (organizationId, limit) {
          ...
          return __generator(this, function (_a) {
            return [
              2 /*return*/,
              this.transactionRepository.findByOrganization(
                organizationId,
                limit,
              ),
            ];
     ...
     */
    CreditSystemService_1.prototype.getRecentUsageLogs = function (
      organizationId_1,
    ) {
      return __awaiter(
        this,
        ...
        function (organizationId, limit) {
          ...
          return __generator(this, function (_a) {
            return [
              2 /*return*/,
              this.usageLogRepository.findByOrganization(organizationId, limit),
            ];
          });
        },
      );
     ...
     */
    CreditSystemService_1.prototype.getUsageStatistics = function (
      organizationId,
      startDate,
      endDate,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            this.usageLogRepository.getUsageStats(
              organizationId,
              startDate,
              endDate,
            ),
     ...
     */
    CreditSystemService_1.prototype.calculateTokenUsage = function (
      modelId,
      messages,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.agentFrameworkDeps.countTokensInMessages(model, messages),
              ];
            case 2:
              tokenCounts = _a.sent();
              return [
            ...
            case 4:
              error_10 = _a.sent();
              this.logger.error(
                'Error calculating token usage: '.concat(error_10.message),
                error_10.stack,
              );
     ...
     */
    CreditSystemService_1.prototype.estimateTokensFromMessages = function (
      messages,
    ) {
      var totalChars = 0;
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (transactions.length > 0) {
                ...
                if (txCreatedAt instanceof Date) {
                  ...
                  txCreatedAt &&
                  typeof txCreatedAt.toDate === 'function'
                ) {
            ...
            case 2:
              ...
              averageLatency =
                this.responseTimeMs.length > 0
                  ? this.responseTimeMs.reduce(function (sum, time) {
                      return sum + time;
                    }, 0) / this.responseTimeMs.length
                  : 0;
              return [
                2 /*return*/,
                {
            ...
            case 3:
              error_11 = _a.sent();
              this.logger.error(
                'Error getting system status: '.concat(error_11.message),
                error_11.stack,
              );
              return [
                2 /*return*/,
     ...
     */
    CreditSystemService_1.prototype.releaseReservation = function (
      reservationId,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!reservation) {
                throw new Error(
                  'Reservation not found: '.concat(reservationId),
                );
              }
              if (reservation.status !== 'pending') {
                throw new Error(
                  'Reservation is not pending: '.concat(reservationId),
                );
              }
              return [
                4 /*yield*/,
            ...
            case 3:
              error_12 = _a.sent();
              this.logger.error(
                'Error releasing reservation: '.concat(error_12.message),
                error_12.stack,
              );
