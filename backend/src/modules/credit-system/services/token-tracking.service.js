...
var TokenTrackingService = (function () {
  ...
  var TokenTrackingService = (_classThis = /** @class */ (function () {
    function TokenTrackingService_1(
      creditSystemService,
     ...
     */
    TokenTrackingService_1.prototype.checkCreditsForModelRequest = function (
      organizationId,
      userId,
      modelId,
      messages,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.creditSystemService.checkCredits({
            ...
            case 3:
              error_1 = _a.sent();
              this.logger.error(
                'Error checking credits for model request: '.concat(
                  error_1.message,
                ),
                error_1.stack,
              );
     ...
     */
    TokenTrackingService_1.prototype.recordAgentResponseUsage = function (
      organizationId,
      userId,
      response,
      reservationId,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.creditSystemService.recordUsage({
                  organizationId: organizationId,
                  userId: userId,
                  usageType: types_1.CreditUsageType.MODEL_CALL,
                  ...
                  operationId:
                    responseMetadata === null || responseMetadata === void 0
                      ? void 0
                      : responseMetadata.operationId,
            ...
            case 2:
              error_2 = _a.sent();
              this.logger.error(
                'Error recording agent response usage: '.concat(
                  error_2.message,
                ),
                error_2.stack,
              );
     ...
     * @returns Whether operation can proceed and reservation ID if applicable
     */
    TokenTrackingService_1.prototype.checkCreditsForEmbedding = function (
      organizationId,
      userId,
      modelId,
      textLength,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              error_3 = _a.sent();
              this.logger.error(
                'Error checking credits for embedding: '.concat(
                  error_3.message,
                ),
                error_3.stack,
              );
     ...
     * @returns Whether operation can proceed and reservation ID if applicable
     */
    TokenTrackingService_1.prototype.checkCreditsForRagQuery = function (
      organizationId,
      userId,
      queryLength,
      documentCount,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              error_4 = _a.sent();
              this.logger.error(
                'Error checking credits for RAG query: '.concat(
                  error_4.message,
                ),
                error_4.stack,
              );
     ...
     */
    TokenTrackingService_1.prototype.optimizeModelSelection = function (
      organizationId,
      userPrompt,
      taskComplexity,
      preferredModel,
      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              allModels = _a.sent();
              activeModels = allModels.filter(function (model) {
                return model.isEnabled;
              });
              // If preferred model is specified, try to use it
              if (preferredModel) {
                model = activeModels.find(function (m) {
                  return m.model === preferredModel;
                });
              ...
              if (taskComplexity === 'simple') {
                ...
                eligibleModels = activeModels.filter(function (m) {
                  return (
                    m.complexity === 'standard' || m.complexity === 'complex'
                  );
                });
              } else {
                eligibleModels = activeModels.filter(function (m) {
              ...
              sortedModels = __spreadArray([], eligibleModels, true).sort(
                function (a, b) {
                  // Calculate total cost
                  var costA =
                    (estimatedTokens_1 * a.costPer1kInputTokens) / 1000 +
                    (estimatedTokens_1 * 0.7 * a.costPer1kOutputTokens) / 1000;
                  var costB =
                    (estimatedTokens_1 * b.costPer1kInputTokens) / 1000 +
            ...
            case 2:
              error_5 = _a.sent();
              this.logger.error(
                'Error optimizing model selection: '.concat(error_5.message),
                error_5.stack,
              );
              return [4 /*yield*/, this.modelRegistryRepository.findAll()];
            case 3:
              ...
              return [
                2 /*return*/,
                {
                  model: defaultModel,
                  reason:
                    'Error optimizing model selection, using fallback model: '.concat(
                      error_5.message,
                    ),
                },
              ];
