...
var VertexAIModelAdapter = function () {
    ...
    var VertexAIModelAdapter = _classThis = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
                        ...
                        this.logger.log("Vertex AI Adapter initialized for project ".concat(this.projectId, " in ").concat(this.location));
                    }
                    catch (error) {
                        this.logger.error("Failed to initialize Vertex AI adapter: ".concat(error.message), error.stack);
                        throw new Error("Failed to initialize Vertex AI adapter: ".concat(error.message));
                    }
                    return [2 /*return*/];
                });
            });
        ...
        VertexAIModelAdapter_1.prototype.supportsModel = function (modelName) {
            ...
            return supportedModels.some(function (model) { return modelName.includes(model) || modelName.startsWith("vertex-"); });
        };
        /**
         ...
         */
        VertexAIModelAdapter_1.prototype.generateCompletion = function (model, request) {
            return __awaiter(this, void 0, void 0, function () {
                var startTime, options, mockResult, tokenCount, outputTokens, cost, processingTime, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            mockResult = this.mockGenerateContent(request.prompt, model.model);
                            return [4 /*yield*/, this.countCompletionTokens(model, request)];
                        case 2:
                            tokenCount = _a.sent();
                            outputTokens = this.countTokens(mockResult.content);
                            cost = this.calculateTokenCost(model, tokenCount.inputTokens, outputTokens);
                        ...
                        case 3:
                            error_1 = _a.sent();
                            this.logger.error("Vertex AI completion error: ".concat(error_1.message), error_1.stack);
         ...
         * @returns Model response
         */
        VertexAIModelAdapter_1.prototype.generateChatCompletion = function (model, request) {
            return __awaiter(this, void 0, void 0, function () {
                var startTime, options, lastMessage, mockResult, tokenCount, outputTokens, cost, processingTime, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.ensureInitialized();
                        ...
                        case 1:
                            ...
                            mockResult = this.mockGenerateContent(lastMessage.content, model.model);
                        ...
                        case 3:
                            error_2 = _a.sent();
                            this.logger.error("Vertex AI chat completion error: ".concat(error_2.message), error_2.stack);
         ...
         */
        VertexAIModelAdapter_1.prototype.countCompletionTokens = function (model, request) {
            return __awaiter(this, void 0, void 0, function () {
                var inputTokens;
                var _a;
                return __generator(this, function (_b) {
                    ...
                    try {
                        ...
                        return [2 /*return*/, {
                                ...
                                estimatedOutputTokens: Math.min(model.maxOutputTokens, ((_a = request.options) === null || _a === void 0 ? void 0 : _a.maxOutputTokens) || model.maxOutputTokens),
                                totalTokens: inputTokens + model.maxOutputTokens,
                            }];
                    }
                    catch (error) {
                        this.logger.error("Vertex AI token counting error: ".concat(error.message), error.stack);
         ...
         * @returns Token count result
         */
        VertexAIModelAdapter_1.prototype.countChatTokens = function (model, request) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    ...
                    try {
                        ...
                        if ((_b = request.options) === null || _b === void 0 ? void 0 : _b.functions) {
                            inputTokens += request.options.functions.reduce(function (total, fn) { return total + _this.countTokens(JSON.stringify(fn)); }, 0);
                        }
                        return [2 /*return*/, {
                                inputTokens: inputTokens,
                                estimatedOutputTokens: Math.min(model.maxOutputTokens, ((_c = request.options) === null || _c === void 0 ? void 0 : _c.maxOutputTokens) || model.maxOutputTokens),
                                totalTokens: inputTokens + model.maxOutputTokens,
                            }];
                    }
                    catch (error) {
                        this.logger.error("Vertex AI chat token counting error: ".concat(error.message), error.stack);
                        throw this.formatError(error);
                    }
                    return [2 /*return*/];
                });
         ...
         */
        VertexAIModelAdapter_1.prototype.validateCredentials = function (credentials) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
                        ...
                        return [2 /*return*/, credentials && credentials.type === "service_account"];
                    }
                    catch (error) {
                        this.logger.error("Vertex AI credential validation error: ".concat(error.message), error.stack);
         ...
         */
        VertexAIModelAdapter_1.prototype.calculateTokenCost = function (model, inputTokens, outputTokens) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    try {
                        ...
                        this.logger.error("Vertex AI model listing error: ".concat(error.message), error.stack);
                        throw this.formatError(error);
                    }
                    return [2 /*return*/];
                });
        ...
        VertexAIModelAdapter_1.prototype.ensureInitialized = function () {
            if (!this.initialized) {
                throw new Error("Vertex AI adapter is not initialized. Call initialize() first.");
            }
        };
        /**
        ...
        VertexAIModelAdapter_1.prototype.mapRequestOptions = function (options) {
            ...
            return {
                ...
                tools: options.functions
                    ? [
                        {
                            functionDeclarations: options.functions.map(function (fn) { return ({
                                name: fn.name,
                ...
                toolConfig: options.functionCall
                    ? {
                        functionCallingConfig: {
                            mode: options.functionCall === "auto"
                                ? "AUTO"
                                : options.functionCall === "none"
                                    ? "NONE"
                                    : "ANY",
                            allowedFunctionNames: typeof options.functionCall === "string"
                                ? undefined
        ...
        VertexAIModelAdapter_1.prototype.formatError = function (error) {
            ...
            if (((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes("Authentication failed")) ||
                ((_b = error.message) === null || _b === void 0 ? void 0 : _b.includes("Permission denied")) ||
                error.code === 403) {
                errorType = types_1.AgentErrorType.AUTHORIZATION_ERROR;
            }
            else if (((_c = error.message) === null || _c === void 0 ? void 0 : _c.includes("model not found")) ||
                ((_d = error.message) === null || _d === void 0 ? void 0 : _d.includes("model is not available")) ||
                error.code === 404) {
                errorType = types_1.AgentErrorType.MODEL_UNAVAILABLE;
            }
            else if (((_e = error.message) === null || _e === void 0 ? void 0 : _e.includes("exceeded quota")) ||
                ((_f = error.message) === null || _f === void 0 ? void 0 : _f.includes("rate limit")) ||
                error.code === 429) {
                errorType = types_1.AgentErrorType.RATE_LIMIT_EXCEEDED;
            }
            else if ((_g = error.message) === null || _g === void 0 ? void 0 : _g.includes("token limit")) {
                errorType = types_1.AgentErrorType.TOKEN_LIMIT_EXCEEDED;
            }
            var formattedError = new Error("Vertex AI error (".concat(errorType, "): ").concat(error.message || "Unknown error"));
         ...
         */
        VertexAIModelAdapter_1.prototype.mockGenerateContent = function (prompt, modelName) {
            ...
            if (prompt.toLowerCase().includes("hello") ||
                ...
                response = "Hello! I'm an AI assistant powered by ".concat(modelName, ". How can I help you today?");
            }
                ...
                response = "I've processed your request using ".concat(modelName, ". Here's a simulated response for development purposes. In production, this would be generated by the actual Vertex AI model.");
            }
            return {
                content: response,
                finishReason: "stop",
