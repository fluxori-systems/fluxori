...
var AgentConversationRepository = (function () {
  ...
  var AgentConversationRepository = (_classThis = /** @class */ (function (
    _super,
  ) {
    __extends(AgentConversationRepository_1, _super);
    function AgentConversationRepository_1(firestoreConfigService) {
      var _this =
        _super.call(this, firestoreConfigService, 'agent_conversations') ||
        this;
     ...
     */
    AgentConversationRepository_1.prototype.findByOrganization = function (
      organizationId_1,
    ) {
      return __awaiter(
        this,
     ...
     * @returns List of conversations
     */
    AgentConversationRepository_1.prototype.findByUser = function (
      organizationId_1,
      userId_1,
    ) {
      return __awaiter(
     ...
     * @returns List of conversations
     */
    AgentConversationRepository_1.prototype.findByAgentConfig = function (
      organizationId_1,
      agentConfigId_1,
    ) {
      return __awaiter(
        ...
        arguments,
        void 0,
        function (organizationId, agentConfigId, limit) {
          if (limit === void 0) {
            limit = 50;
          }
          return __generator(this, function (_a) {
     ...
     */
    AgentConversationRepository_1.prototype.addMessage = function (
      conversationId,
      message,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [4 /*yield*/, this.findById(conversationId)];
            case 1:
              conversation = _c.sent();
              if (!conversation) return [2 /*return*/, null];
              updatedMessages = __spreadArray(
                __spreadArray([], conversation.messages, true),
                [message],
                false,
              );
              ...
              return [
                ...
                this.update(
                  ...
                  __assign(
                    __assign(
                      { messages: updatedMessages, lastActivityAt: new Date() },
                      (
                        (_a = message.metadata) === null || _a === void 0
                          ? void 0
                          : _a.tokenCount
                      )
                        ? {
                    ...
                    (
                      (_b = message.metadata) === null || _b === void 0
                        ? void 0
                        : _b.cost
                    )
                      ? {
     ...
     * @returns Updated conversation or null if not found
     */
    AgentConversationRepository_1.prototype.setActive = function (
      conversationId,
      isActive,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            this.update(conversationId, { isActive: isActive }),
          ];
        });
      });
    };
     ...
     * @returns Updated conversation or null if not found
     */
    AgentConversationRepository_1.prototype.updateTitle = function (
      conversationId,
      title,
    ) {
      return __awaiter(this, void 0, void 0, function () {
     ...
     */
    AgentConversationRepository_1.prototype.archiveOldUserConversations =
      function (organizationId_1, userId_1) {
        return __awaiter(
          this,
          arguments,
          void 0,
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  return [
                    4 /*yield*/,
                    this.findByUser(organizationId, userId, 1000),
                  ];
                case 1:
