...
var TokenEstimator = function () {
    ...
    var TokenEstimator = _classThis = /** @class */ (function () {
         ...
         */
        TokenEstimator_1.prototype.estimateTokensForString = function (text, languageType) {
            if (languageType === void 0) { languageType = "default"; }
            if (!text)
                return 0;
            // Get the appropriate tokens-per-character ratio
            var ratio = this.avgTokensPerChar[languageType] || this.avgTokensPerChar.default;
        ...
        TokenEstimator_1.prototype.isLikelyCode = function (text) {
            ...
            var matchCount = 0;
            for (var _i = 0, codePatterns_1 = codePatterns; _i < codePatterns_1.length; _i++) {
            ...
            if (message.functionCall) {
                ...
                if (typeof message.functionCall.arguments === "string") {
                    ...
                    try {
                        ...
                        this.logger.warn("Could not serialize function arguments: ".concat(error.message));
                    }
                }
         ...
         * @returns Estimated token count
         */
        TokenEstimator_1.prototype.estimateTokensForConversation = function (messages) {
         ...
         * @returns Estimated token count
         */
        TokenEstimator_1.prototype.estimateTokensForFunctions = function (functions) {
            var tokens = 0;
            for (var _i = 0, functions_1 = functions; _i < functions_1.length; _i++) {
                ...
                try {
                    ...
                    this.logger.warn("Could not serialize function parameters: ".concat(error.message));
                }
            }
            return tokens;
        };
