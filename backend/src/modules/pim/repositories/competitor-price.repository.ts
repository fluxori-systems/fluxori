...
import { CompetitorPrice, MarketPosition, PriceSourceType, PriceVerificationStatus } from '../models/competitor-price.model';
...
export class CompetitorPriceRepository extends FirestoreBaseRepository<CompetitorPrice> {
   ...
   */
  async create(data: Omit<CompetitorPrice, 'id' | 'createdAt' | 'updatedAt'>): Promise<CompetitorPrice> {
    try {
      const now = new Date();
      ...
      this.logger.error(`Error creating competitor price record: ${error.message}`, error.stack);
      throw error;
    }
  }
   ...
   */
  async update(id: string, data: Partial<CompetitorPrice>): Promise<CompetitorPrice> {
    try {
      const updateData = {
        ...data,
        updatedAt: new Date(),
      ...
      this.logger.error(`Error updating competitor price: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async findByProductId(
    ...
    try {
      ...
      this.logger.error(`Error finding competitor prices: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async findByProductIds(
    ...
    try {
      ...
      this.logger.error(`Error finding competitor prices by product IDs: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async findByCompetitorId(
    ...
    try {
      ...
      this.logger.error(`Error finding prices by competitor: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async findByMarketplaceId(
    ...
    try {
      ...
      this.logger.error(`Error finding prices by marketplace: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async findRecentlyUpdated(
    ...
    try {
      ...
      this.logger.error(`Error finding recently updated prices: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async findPendingVerification(
    ...
    try {
      const query = {
        where: [
          { field: 'organizationId', operator: '==', value: organizationId },
          { field: 'verificationStatus', operator: '==', value: PriceVerificationStatus.PENDING },
        ],
        limit,
      ...
      this.logger.error(`Error finding prices pending verification: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async calculateMarketPosition(
    ...
    try {
      ...
      this.logger.error(`Error calculating market position: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async findBuyBoxPrice(
    ...
    try {
      ...
      this.logger.error(`Error finding BuyBox price: ${error.message}`, error.stack);
      throw error;
    }
  }
  ...
  async findPricesNeedingUpdate(
    ...
    try {
      ...
      this.logger.error(`Error finding prices needing update: ${error.message}`, error.stack);
      throw error;
    }
  }
}