...
import { Category, CategoryStatus, CategoryNode } from "../models/category.model";
...
describe("CategoryService", () => {
  ...
  describe("createCategory", () => {
    ...
    it("should create a child category", async () => {
      ...
      expect(categoryRepository.update).toHaveBeenCalledWith("parent-123", { childCount: 1 });
    });
  });
  ...
  describe("getCategoryTree", () => {
    it("should return the category tree", async () => {
      ...
      expect(categoryRepository.getCategoryTree).toHaveBeenCalledWith("org-123", false, 10);
    });
  });
});