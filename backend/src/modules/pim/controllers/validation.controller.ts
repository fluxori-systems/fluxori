...
export class ValidationController {
  ...
  async validateForMarketplace(
    ...
    this.logger.log(`Validating product ${productId} for marketplace ${marketplaceId}`);
    ...
    try {
      ...
      this.logger.error(`Marketplace validation failed: ${error.message}`, error.stack);
  ...
  async checkMarketplaceValidity(
    ...
    try {
      ...
      this.logger.error(`Marketplace summary failed: ${error.message}`, error.stack);
