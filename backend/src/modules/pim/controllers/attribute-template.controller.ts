...
export class AttributeTemplateController {
  ...
  async getAttributeTemplateById(
    ...
    const attributeTemplate = await this.attributeTemplateService.getAttributeTemplateById(id, organizationId);
    
    if (!attributeTemplate) {
      throw new HttpException('Attribute template not found', HttpStatus.NOT_FOUND);
    }
  ...
  async createAttributeTemplate(
    ...
    return await this.attributeTemplateService.createAttributeTemplate(createAttributeTemplateDto);
  }
  ...
  async updateAttributeTemplate(
    ...
    return await this.attributeTemplateService.updateAttributeTemplate(id, updateAttributeTemplateDto);
  }
  ...
  async getAttributeTemplatesByCategory(
    ...
    const organizationId = user.organizationId;
    return await this.attributeTemplateService.getAttributeTemplatesByCategory(organizationId, categoryId);
  }
  ...
  async getGlobalAttributeTemplates(
    ...
    const organizationId = user.organizationId;
    return await this.attributeTemplateService.getGlobalAttributeTemplates(organizationId);
  }
  ...
  async getAttributeTemplatesByRegion(
    ...
    const organizationId = user.organizationId;
    return await this.attributeTemplateService.getAttributeTemplatesByRegion(organizationId, region);
  }
  ...
  async getAttributeTemplatesByMarketplace(
    ...
    const organizationId = user.organizationId;
    return await this.attributeTemplateService.getAttributeTemplatesByMarketplace(organizationId, marketplaceId);
  }
  ...
  async getApplicableAttributeTemplates(
    ...
    const marketplaceIds = marketplaceIdsParam ? marketplaceIdsParam.split(',') : [];
  ...
  async bulkUpdateAttributeTemplates(
    @Body() operations: Array<{ id: string, updates: UpdateAttributeTemplateDto }>,
    @GetUser() user: User
    ...
    return await this.attributeTemplateService.bulkUpdateAttributeTemplates(operations);
  }
  ...
  async bulkDeleteAttributeTemplates(
    ...
    const organizationId = user.organizationId;
    return await this.attributeTemplateService.bulkDeleteAttributeTemplates(organizationId, body.templateIds);
  }
}