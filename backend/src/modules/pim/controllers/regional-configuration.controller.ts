...
export class RegionalConfigurationController {
  ...
  async getAllRegions(
    ...
    try {
      if (active === true) {
        const regions = await this.regionalConfigService.getAllRegions(
          user.tenantId,
        );
      ...
      this.logger.error(
        `Error fetching region configurations: ${error.message}`,
        error.stack,
      );
   ...
   */
  @Get(':id')
  async getRegionById(@Param('id') id: string, @GetUser() user: any) {
    try {
      return this.regionalConfigService.getRegionById(id, user.tenantId);
    } catch (error) {
      this.logger.error(
        `Error fetching region configuration: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async getRegionByCountryCode(
    ...
    try {
      return this.regionalConfigService.getRegionByCountryCode(
        countryCode,
        user.tenantId,
      );
    } catch (error) {
  ...
  async createRegion(
    ...
    try {
      return this.regionalConfigService.createRegion(
        createRegionDto,
        user.tenantId,
      );
    } catch (error) {
      this.logger.error(
        `Error creating region configuration: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async updateRegion(
    ...
    try {
      return this.regionalConfigService.updateRegion(
        id,
        updateRegionDto,
        user.tenantId,
      );
      ...
      this.logger.error(
        `Error updating region configuration: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
   ...
   */
  @Delete(':id')
  async deleteRegion(@Param('id') id: string, @GetUser() user: any) {
    try {
      const success = await this.regionalConfigService.deleteRegion(
        id,
        user.tenantId,
      );
      return {
      ...
      this.logger.error(
        `Error deleting region configuration: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async getSupportedLanguages(@GetUser() user: any) {
    try {
      return this.regionalConfigService.getSupportedLanguages(user.tenantId);
    } catch (error) {
      this.logger.error(
        `Error fetching supported languages: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async getSupportedCurrencies(@GetUser() user: any) {
    try {
      return this.regionalConfigService.getSupportedCurrencies(user.tenantId);
    } catch (error) {
      this.logger.error(
        `Error fetching supported currencies: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async getAllMarketplaces(@GetUser() user: any) {
    try {
      return this.regionalConfigService.getAllMarketplaces(user.tenantId);
    } catch (error) {
      this.logger.error(
        `Error fetching marketplaces: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
   ...
   */
  @Get(':id/marketplaces')
  async getMarketplacesByRegion(@Param('id') id: string, @GetUser() user: any) {
    try {
      return this.regionalConfigService.getMarketplacesByRegion(
        id,
        user.tenantId,
      );
    } catch (error) {
      this.logger.error(
        `Error fetching marketplaces for region: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async getLocalizationSettings(
    ...
    try {
      return this.regionalConfigService.getLocalizationSettings(
        id,
        language,
        user.tenantId,
      );
      ...
      this.logger.error(
        `Error fetching localization settings: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async initializeDefaultRegions(@GetUser() user: any) {
    try {
      await this.regionalConfigService.initializeDefaultRegions(user.tenantId);
      return {
        success: true,
        message: 'Default regions initialized successfully',
      };
    } catch (error) {
      this.logger.error(
        `Error initializing default regions: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async isFeatureEnabled(
    ...
    try {
      const isEnabled =
        await this.regionalConfigService.isFeatureEnabledForRegion(
          id,
          featureKey,
          user.tenantId,
        );
      ...
      this.logger.error(
        `Error checking region feature: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
