...
import { Category, CategoryNode, CreateCategoryDto, UpdateCategoryDto } from '../models/category.model';
...
export class CategoryController {
  ...
  async getCategoryById(
    ...
    const category = await this.categoryService.getCategoryById(id, organizationId);
  ...
  async findCategories(
    ...
    if (filterParams.maxDepth) filter.maxDepth = parseInt(filterParams.maxDepth);
  ...
  async getCategoryTree(
    ...
    const organizationId = user.organizationId;
    return await this.categoryService.getCategoryTree(organizationId, rootOnly, maxDepth);
  }
  ...
  async getChildCategories(
    ...
    const organizationId = user.organizationId;
    return await this.categoryService.getChildCategories(organizationId, parentId);
  }
  ...
  async getCategoriesByMarketplace(
    ...
    const organizationId = user.organizationId;
    return await this.categoryService.getCategoriesByMarketplace(organizationId, marketplaceId);
  }
  ...
  async bulkDeleteCategories(
    ...
    const organizationId = user.organizationId;
    return await this.categoryService.bulkDeleteCategories(organizationId, body.categoryIds);
  }
