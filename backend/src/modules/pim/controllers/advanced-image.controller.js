...
var AdvancedImageController = (function () {
  var _classDecorators = [
    (0, common_1.Controller)('pim/advanced-image'),
  ...
  var AdvancedImageController = (_classThis = /** @class */ (function () {
    function AdvancedImageController_1(
     ...
     */
    AdvancedImageController_1.prototype.uploadImageWithAnalysis = function (
      data,
      user,
    ) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              if (adaptiveCompression) {
                if (networkQuality.quality === 'low') {
                  ...
                  effectiveCompressionQuality =
                    image_model_1.CompressionQuality.HIGH;
                }
              }
              return [
                4 /*yield*/,
                this.pimStorageService.uploadProductImage(
                  file,
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.imageAnalysisService.optimizeImageMetadata(
                  uploadedImage,
            ...
            case 2:
              ...
              if (
                ...
                optimizationResult.updatedImage
              ) {
            ...
            case 4:
              ...
              throw new common_1.HttpException(
                'Failed to upload and analyze image: '.concat(errorMessage),
     ...
     */
    AdvancedImageController_1.prototype.analyzeExistingImage = function (
      imageId,
      options,
      user,
    ) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.pimStorageService.getProductImage(imageId, organizationId),
              ];
            case 1:
              image = _a.sent();
              if (!image) {
              ...
              analysisOptions = {
                ...
                includeQualityAssessment:
                  options.includeQualityAssessment !== false,
              };
              return [
                4 /*yield*/,
                this.imageAnalysisService.analyzeImage(
                  image.publicUrl,
                  options.productContext,
                  organizationId,
                  user.uid,
            ...
            case 3:
              ...
              throw new common_1.HttpException(
                'Failed to analyze image: '.concat(errorMessage),
                common_1.HttpStatus.INTERNAL_SERVER_ERROR,
              );
            case 4:
              return [2 /*return*/];
     ...
     */
    AdvancedImageController_1.prototype.generateAltText = function (
      imageId,
      data,
      user,
    ) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.imageAnalysisService.generateAltText(
                  image.publicUrl,
                  data.productContext,
                  organizationId,
                  user.uid,
            ...
            case 5:
              ...
              throw new common_1.HttpException(
                'Failed to generate alt text: '.concat(errorMessage),
                common_1.HttpStatus.INTERNAL_SERVER_ERROR,
              );
            case 6:
              return [2 /*return*/];
     ...
     */
    AdvancedImageController_1.prototype.checkMarketplaceCompliance = function (
      imageId,
      marketplace,
      user,
    ) {
          ...
          switch (_c.label) {
            ...
            case 2:
              ...
              return [
                ...
                {
                  compliant:
                    ((_a = analysisResult.marketplaceCompliance) === null ||
                    _a === void 0
                      ? void 0
                      : _a.compliant) || false,
                  issues:
                    (_b = analysisResult.marketplaceCompliance) === null ||
                    _b === void 0
                      ? void 0
                      : _b.issues,
            ...
            case 3:
              ...
              throw new common_1.HttpException(
                'Failed to check marketplace compliance: '.concat(errorMessage),
                common_1.HttpStatus.INTERNAL_SERVER_ERROR,
              );
            case 4:
              return [2 /*return*/];
     ...
     */
    AdvancedImageController_1.prototype.assessImageQuality = function (
      imageId,
      user,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.imageAnalysisService.assessImageQuality(
                  image.publicUrl,
                  organizationId,
                  user.uid,
                ),
            ...
            case 3:
              error_5 = _a.sent();
              errorMessage =
                error_5 instanceof Error ? error_5.message : String(error_5);
              throw new common_1.HttpException(
                'Failed to assess image quality: '.concat(errorMessage),
                common_1.HttpStatus.INTERNAL_SERVER_ERROR,
              );
            case 4:
              return [2 /*return*/];
     ...
     */
    AdvancedImageController_1.prototype.selectMainProductImage = function (
      productId,
      data,
      user,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        var organizationId_1,
          images,
          result_1,
          mainImage,
          error_6,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.pimStorageService.getProductImages(
                  productId,
                  organizationId_1,
                ),
              ];
            case 1:
              ...
              return [
                4 /*yield*/,
                this.imageAnalysisService.identifyMainProductImage(
                  images,
                  data.productContext,
                  organizationId_1,
                  user.uid,
            ...
            case 2:
              ...
              if (
                !(
                  result_1.success &&
                  result_1.mainImageIndex !== undefined &&
                  result_1.mainImageIndex >= 0
                )
              )
                return [3 /*break*/, 4];
              ...
              return [
                ...
                Promise.all(
                  images.map(function (image, index) {
                    return _this.pimStorageService.updateProductImage(
                      image.id,
                      { isMain: index === result_1.mainImageIndex },
                      organizationId_1,
                    );
                  }),
                ),
            ...
            case 3:
              ...
              return [
                2 /*return*/,
                __assign(__assign({}, result_1), { mainImage: mainImage }),
              ];
            case 4:
            ...
            case 5:
              error_6 = _a.sent();
              errorMessage =
                error_6 instanceof Error ? error_6.message : String(error_6);
              throw new common_1.HttpException(
                'Failed to select main product image: '.concat(errorMessage),
                common_1.HttpStatus.INTERNAL_SERVER_ERROR,
              );
            case 6:
              return [2 /*return*/];
     ...
     */
    AdvancedImageController_1.prototype.getAdaptiveCompressionSettings =
      function () {
        return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            ...
            if (networkQuality.quality === 'low') {
              recommendedSettings = __assign(
                __assign({}, recommendedSettings),
                {
  ...
  (function () {
    ...
    _generateAltText_decorators = [
      (0, common_1.Post)('generate-alt-text/:imageId'),
    ];
    _checkMarketplaceCompliance_decorators = [
      (0, common_1.Get)('marketplace-compliance/:imageId'),
    ];
    _assessImageQuality_decorators = [
      (0, common_1.Get)('quality-assessment/:imageId'),
    ];
    _selectMainProductImage_decorators = [
      (0, common_1.Post)('select-main-image/:productId'),
    ];
    _getAdaptiveCompressionSettings_decorators = [
      (0, common_1.Get)('adaptive-compression-settings'),
    ];
    __esDecorate(
      _classThis,
      null,
      _uploadImageWithAnalysis_decorators,
      {
        kind: 'method',
        name: 'uploadImageWithAnalysis',
        static: false,
        private: false,
        access: {
          has: function (obj) {
            return 'uploadImageWithAnalysis' in obj;
          },
          get: function (obj) {
            return obj.uploadImageWithAnalysis;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      _classThis,
      null,
      _analyzeExistingImage_decorators,
      {
        kind: 'method',
        name: 'analyzeExistingImage',
        static: false,
        private: false,
        access: {
          has: function (obj) {
            return 'analyzeExistingImage' in obj;
          },
          get: function (obj) {
            return obj.analyzeExistingImage;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _generateAltText_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'generateAltText' in obj;
          },
          get: function (obj) {
            return obj.generateAltText;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      {
        kind: 'method',
        name: 'checkMarketplaceCompliance',
        static: false,
        private: false,
        access: {
          has: function (obj) {
            return 'checkMarketplaceCompliance' in obj;
          },
          get: function (obj) {
            return obj.checkMarketplaceCompliance;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      _assessImageQuality_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'assessImageQuality' in obj;
          },
          get: function (obj) {
            return obj.assessImageQuality;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      {
        kind: 'method',
        name: 'selectMainProductImage',
        static: false,
        private: false,
        access: {
          has: function (obj) {
            return 'selectMainProductImage' in obj;
          },
          get: function (obj) {
            return obj.selectMainProductImage;
          },
        },
        metadata: _metadata,
      },
    ...
    __esDecorate(
      ...
      {
        kind: 'method',
        name: 'getAdaptiveCompressionSettings',
        static: false,
        private: false,
        access: {
          has: function (obj) {
            return 'getAdaptiveCompressionSettings' in obj;
          },
          get: function (obj) {
            return obj.getAdaptiveCompressionSettings;
          },
        },
        metadata: _metadata,
      },
