...
export interface PriceMonitoringConfig {
  ...
  priceStrategy?: {
     ...
     * Strategy type
     */
    type: 'MATCH' | 'BEAT_BY_PERCENTAGE' | 'BEAT_BY_AMOUNT' | 'MAINTAIN_POSITION';
...
export interface PriceAlert {
   ...
   * Alert type
   */
  alertType: 'COMPETITOR_PRICE_DECREASE' | 'COMPETITOR_PRICE_INCREASE' | 'BUYBOX_LOST' | 'STOCK_STATUS_CHANGE' | 'NEW_COMPETITOR' | 'PRICE_ADJUSTMENT_RECOMMENDED';
