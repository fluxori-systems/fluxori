...
var LoadSheddingResilienceService = function () {
    ...
    var LoadSheddingResilienceService = _classThis = /** @class */ (function () {
        function LoadSheddingResilienceService_1(configService, featureFlagService, marketContextService) {
        ...
        LoadSheddingResilienceService_1.prototype.onModuleInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.featureFlagService.isEnabled('pim.loadSheddingResilience', {
                        ...
                        case 1:
                            ...
                            queueIntervalMs = this.configService.get('LOAD_SHEDDING_QUEUE_INTERVAL_MS') || 30000;
                            this.processingInterval = setInterval(function () { return _this.processQueue(); }, queueIntervalMs);
                            checkIntervalMs = this.configService.get('LOAD_SHEDDING_CHECK_INTERVAL_MS') || 300000;
                            this.checkInterval = setInterval(function () { return _this.updateLoadSheddingStatus(); }, checkIntervalMs);
         ...
         */
        LoadSheddingResilienceService_1.prototype.updateLoadSheddingStatus = function () {
            return __awaiter(this, void 0, void 0, function () {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            this.loadSheddingInfo = {
                                ...
                                nextStartTime: simulatedSchedule.stage > 0 ? simulatedSchedule.startTime : undefined,
                                nextEndTime: simulatedSchedule.stage > 0 ? simulatedSchedule.endTime : undefined,
                                areaCode: 'Area 7',
                                areaName: 'Johannesburg North'
                            };
                            // Log current status
                            this.logger.debug("Load shedding status: Stage ".concat(this.loadSheddingInfo.stage, ", Active: ").concat(this.loadSheddingInfo.active));
                            if (!(!this.loadSheddingInfo.active && this.operationQueue.length > 0 && !this.isProcessingQueue)) return [3 /*break*/, 2];
                        ...
                        case 3:
                            error_1 = _a.sent();
                            this.logger.error("Error updating load shedding status: ".concat(error_1 instanceof Error ? error_1.message : String(error_1)));
                            return [3 /*break*/, 4];
                        case 4: return [2 /*return*/];
                    }
                });
         ...
         */
        LoadSheddingResilienceService_1.prototype.enqueueOperation = function (type_1, params_1, callback_1) {
            return __awaiter(this, arguments, void 0, function (type, params, callback, options) {
                var id;
                var _this = this;
                if (options === void 0) { options = {}; }
                return __generator(this, function (_a) {
                    id = "op_".concat(Date.now(), "_").concat(Math.random().toString(36).substring(2, 10));
                    ...
                    this.logger.log("Enqueued operation ".concat(id, " of type ").concat(type, " with priority ").concat(options.priority || 5));
        ...
        LoadSheddingResilienceService_1.prototype.processQueue = function () {
            return __awaiter(this, void 0, void 0, function () {
                var criticalOnly, sortedQueue, batchSize, batch_1, results, completedIds_1, error_2;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (this.loadSheddingInfo.active) {
                                criticalOnly = this.operationQueue.filter(function (op) { return op.priority <= 3; });
                                if (criticalOnly.length === 0) {
                                    this.logger.log('Load shedding active, no critical operations to process');
                                    return [2 /*return*/];
                                }
                            }
                        ...
                        case 1:
                            ...
                            sortedQueue = __spreadArray([], this.operationQueue, true).sort(function (a, b) { return a.priority - b.priority; });
                            batchSize = this.loadSheddingInfo.active ? 3 : 10;
                            batch_1 = sortedQueue.slice(0, batchSize);
                            this.logger.log("Processing ".concat(batch_1.length, " operations from queue (").concat(this.operationQueue.length, " total)"));
                            return [4 /*yield*/, Promise.allSettled(batch_1.map(function (op) { return _this.executeOperation(op); }))];
                        case 2:
                            results = _a.sent();
                            completedIds_1 = results
                                .map(function (result, index) { return result.status === 'fulfilled' && result.value ? batch_1[index].id : null; })
                                .filter(function (id) { return id !== null; });
                            this.operationQueue = this.operationQueue.filter(function (op) { return !completedIds_1.includes(op.id); });
                            this.logger.log("Completed ".concat(completedIds_1.length, " operations, ").concat(this.operationQueue.length, " remaining in queue"));
                            return [3 /*break*/, 5];
                        case 3:
                            error_2 = _a.sent();
                            this.logger.error("Error processing operation queue: ".concat(error_2 instanceof Error ? error_2.message : String(error_2)));
                            return [3 /*break*/, 5];
                        case 4:
                            this.isProcessingQueue = false;
                            return [7 /*endfinally*/];
         ...
         */
        LoadSheddingResilienceService_1.prototype.executeOperation = function (operation) {
            return __awaiter(this, void 0, void 0, function () {
                var error_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            // Execute the operation
                            _a.sent();
                            this.logger.log("Successfully executed operation ".concat(operation.id, " of type ").concat(operation.type));
                            return [2 /*return*/, true];
                        case 2:
                            error_3 = _a.sent();
                            // Log the error
                            this.logger.error("Error executing operation ".concat(operation.id, " of type ").concat(operation.type, ": ").concat(error_3 instanceof Error ? error_3.message : String(error_3)));
                            // Check if we should retry
                            if (operation.retries < operation.maxRetries) {
                                this.logger.log("Operation ".concat(operation.id, " will be retried (").concat(operation.retries, "/").concat(operation.maxRetries, ")"));
                                return [2 /*return*/, false]; // Keep in queue for retry
                            }
                            else {
                                this.logger.warn("Operation ".concat(operation.id, " failed after ").concat(operation.retries, " retries and will be removed from queue"));
         ...
         */
        LoadSheddingResilienceService_1.prototype.executeWithResilience = function (type_1, params_1, callback_1) {
            return __awaiter(this, arguments, void 0, function (type, params, callback, options) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (options.cacheKey) {
                                ...
                                if (cached) {
                                    this.logger.debug("Cache hit for key ".concat(options.cacheKey));
                                    return [2 /*return*/, cached];
                                }
                            }
                            executeImmediately = options.executeImmediatelyIfPossible !== false &&
                        ...
                        case 3:
                            ...
                            this.logger.warn("Operation ".concat(type, " failed with error: ").concat(error_4 instanceof Error ? error_4.message : String(error_4), ". Queueing for retry."));
                            return [4 /*yield*/, this.enqueueOperation(type, params, callback, {
                        ...
                        return [4 /*yield*/, this.enqueueOperation(type, params, function (p) { return __awaiter(_this, void 0, void 0, function () {
                                var result;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, callback(p)];
                                        case 1:
                                            result = _a.sent();
                                            // Cache result if cache key is provided
                                            if (options.cacheKey) {
         ...
         */
        LoadSheddingResilienceService_1.prototype.executeBatchWithResilience = function (items_1, callback_1) {
            return __awaiter(this, arguments, void 0, function (items, callback, options) {
                var batchSize, pauseAfterBatch_1, retryCount_1, retryDelay_1, continueOnError, processed_1, succeeded_1, failed_1, results, i, batch, loadSheddingStatus, batchPromises, batchResults, error_5;
                var _this = this;
                if (options === void 0) { options = {}; }
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this.logger.log("Processing batch ".concat(Math.floor(i / batchSize) + 1, " of ").concat(Math.ceil(items.length / batchSize)));
                            return [4 /*yield*/, this.getLoadSheddingInfo()];
                        case 2:
                            loadSheddingStatus = _a.sent();
                            if (!(loadSheddingStatus.active && loadSheddingStatus.stage > 4)) return [3 /*break*/, 4];
                            // Skip processing during severe load shedding
                            this.logger.warn("Pausing batch processing due to load shedding stage ".concat(loadSheddingStatus.stage));
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            _a.label = 1;
                                        case 1:
                                            if (!(retries <= retryCount_1 && !success)) return [3 /*break*/, 8];
                                            _a.label = 2;
                                        case 2:
                                            _a.trys.push([2, 6, , 7]);
                                            if (!(retries > 0)) return [3 /*break*/, 4];
                                            this.logger.log("Retry ".concat(retries, "/").concat(retryCount_1, " for item"));
                                            // Wait before retry
                                        ...
                                        case 3:
                                            ...
                                            _a.sent();
                                            _a.label = 4;
                                        case 4: return [4 /*yield*/, callback(item)];
                                        case 5:
                                            result = _a.sent();
                                            success = true;
                                            return [3 /*break*/, 7];
                                        case 6:
                                            ...
                                            this.logger.warn("Error processing item (retry ".concat(retries, "/").concat(retryCount_1, "): ").concat(lastError.message));
                                            retries++;
                                            return [3 /*break*/, 7];
                        ...
                        case 5:
                            ...
                            if (!continueOnError && batchResults.some(function (r) { return !r.success; })) {
                                this.logger.error('Stopping batch processing due to errors and continueOnError=false');
                                return [3 /*break*/, 8];
                            }
                            if (!(i + batchSize < items.length)) return [3 /*break*/, 7];
                            this.logger.debug("Pausing for ".concat(pauseAfterBatch_1, "ms between batches"));
                            return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, pauseAfterBatch_1); })];
                        case 6:
                            _a.sent();
                            _a.label = 7;
                        case 7:
                        ...
                        case 9:
                            error_5 = _a.sent();
                            this.logger.error("Error in batch execution: ".concat(error_5 instanceof Error ? error_5.message : String(error_5)));
                            throw error_5;
         ...
         */
        LoadSheddingResilienceService_1.prototype.getLoadSheddingInfo = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        LoadSheddingResilienceService_1.prototype.getCurrentStatus = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getLoadSheddingInfo()];
                        case 1:
                            info = _a.sent();
                            // Add currentStage field for backward compatibility
                            return [2 /*return*/, __assign(__assign({}, info), { currentStage: info.stage })];
                    }
                });
            });
        };
         ...
         */
        LoadSheddingResilienceService_1.prototype.isLoadSheddingActive = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
         ...
         */
        LoadSheddingResilienceService_1.prototype.getLoadSheddingStage = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
         ...
         */
        LoadSheddingResilienceService_1.prototype.addToCache = function (key, data, ttlMs) {
