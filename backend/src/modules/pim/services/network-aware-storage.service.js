...
var NetworkAwareStorageService = function () {
    ...
    var NetworkAwareStorageService = _classThis = /** @class */ (function () {
        function NetworkAwareStorageService_1(storageService, configService, featureFlagService, marketContextService) {
        ...
        NetworkAwareStorageService_1.prototype.onModuleInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                var isLoadSheddingResilience, processingIntervalMs, networkCheckIntervalMs;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            processingIntervalMs = this.configService.get('QUEUE_PROCESSING_INTERVAL_MS') || 30000;
                            this.processingInterval = setInterval(function () { return _this.processQueue(); }, processingIntervalMs);
                            networkCheckIntervalMs = this.configService.get('NETWORK_CHECK_INTERVAL_MS') || 60000;
                            setInterval(function () { return _this.updateNetworkStatus(); }, networkCheckIntervalMs);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.logger.debug("Network status: ".concat(JSON.stringify(this.networkStatus)));
                            if (!(!this.loadSheddingActive && this.operationQueue.length > 0 && !this.isProcessingQueue)) return [3 /*break*/, 2];
                        ...
                        case 3:
                            ...
                            this.logger.error("Error updating network status: ".concat(errorMessage), errorStack);
                            return [3 /*break*/, 4];
                        case 4: return [2 /*return*/];
                    }
                });
        ...
        NetworkAwareStorageService_1.prototype.processQueue = function () {
            return __awaiter(this, void 0, void 0, function () {
                var sortedQueue, batch_1, processingResults, _loop_1, this_1, i, error_2, errorMessage, errorStack;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            sortedQueue = __spreadArray([], this.operationQueue, true).sort(function (a, b) {
                            ...
                            return [4 /*yield*/, Promise.allSettled(batch_1.map(function (entry) { return _this.processQueueEntry(entry); }))];
                        case 2:
                            processingResults = _a.sent();
                            _loop_1 = function (i) {
                                var result = processingResults[i];
                                if (result.status === 'fulfilled' && result.value) {
                                    this_1.operationQueue = this_1.operationQueue.filter(function (entry) { return entry.id !== batch_1[i].id; });
                                }
                            };
                            this_1 = this;
                            ...
                            this.logger.log("Processed ".concat(batch_1.length, " queued operations, ").concat(this.operationQueue.length, " remaining"));
                            return [3 /*break*/, 5];
                        case 3:
                            error_2 = _a.sent();
                            errorMessage = error_2 instanceof Error ? error_2.message : String(error_2);
                            errorStack = error_2 instanceof Error ? error_2.stack : undefined;
                            this.logger.error("Error processing operation queue: ".concat(errorMessage), errorStack);
                            return [3 /*break*/, 5];
                        case 4:
                            this.isProcessingQueue = false;
                            return [7 /*endfinally*/];
         ...
         */
        NetworkAwareStorageService_1.prototype.processQueueEntry = function (entry) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [3 /*break*/, 6];
                        case 1: return [4 /*yield*/, this.storageService.uploadFile(entry.params.file, entry.params.filePath, entry.params.options)];
                        case 2:
                            _b.sent();
                            return [3 /*break*/, 6];
                        case 3: return [4 /*yield*/, this.storageService.deleteFile(entry.params.filePath)];
                        case 4:
                            _b.sent();
                            return [3 /*break*/, 6];
                        case 5: 
                        ...
                        return [3 /*break*/, 6];
                        case 6:
                            this.logger.log("Successfully processed queued operation ".concat(entry.id, " (").concat(entry.operation, ")"));
                        ...
                        case 7:
                            ...
                            if (entry.retries < maxRetries) {
                                this.logger.warn("Failed to process operation ".concat(entry.id, ", will retry (").concat(entry.retries, "/").concat(maxRetries, "): ").concat(errorMessage));
                                return [2 /*return*/, false];
                            }
                            else {
                                this.logger.error("Failed to process operation ".concat(entry.id, " after ").concat(entry.retries, " retries: ").concat(errorMessage));
         ...
         */
        NetworkAwareStorageService_1.prototype.queueOperation = function (operation, params, priority) {
            if (priority === void 0) { priority = 'medium'; }
            var id = "op-".concat(Date.now(), "-").concat(Math.random().toString(36).substring(2, 10));
            ...
            this.logger.log("Queued ".concat(operation, " operation ").concat(id, " with ").concat(priority, " priority"));
            return id;
        };
        /**
         ...
         */
        NetworkAwareStorageService_1.prototype.uploadFile = function (file, filePath, options) {
            return __awaiter(this, void 0, void 0, function () {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if ((this.loadSheddingActive || this.networkStatus.connectionQuality === 'low') &&
                                ((options === null || options === void 0 ? void 0 : options.enableLoadSheddingResilience) !== false)) {
                                // Queue the operation for later
                                this.queueOperation('upload', { file: file, filePath: filePath, options: options }, 'medium');
                                bucketName = this.configService.get('GCS_BUCKET_NAME') || 'fluxori-uploads';
                        ...
                        case 3:
                            ...
                            if ((options === null || options === void 0 ? void 0 : options.enableLoadSheddingResilience) !== false) {
                                this.queueOperation('upload', { file: file, filePath: filePath, options: options }, 'medium');
                                bucketName = this.configService.get('GCS_BUCKET_NAME') || 'fluxori-uploads';
                                return [2 /*return*/, "https://storage.googleapis.com/".concat(bucketName, "/").concat(filePath)];
                            }
         ...
         */
        NetworkAwareStorageService_1.prototype.deleteFile = function (filePath, options) {
            return __awaiter(this, void 0, void 0, function () {
                var error_5;
                return __generator(this, function (_a) {
                    switch (_a.label) {
         ...
         */
        NetworkAwareStorageService_1.prototype.getNetworkOptimizedImageOptions = function (originalOptions) {
            return __awaiter(this, void 0, void 0, function () {
                var optimizedOptions, networkQuality, organizationId, marketContext, isNetworkAwareEnabled, connectionQuality;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            optimizedOptions = __assign({}, originalOptions);
                            networkQuality = originalOptions.networkQuality || this.networkStatus;
                            organizationId = (_a = originalOptions.metadata) === null || _a === void 0 ? void 0 : _a.organizationId;
                            if (!organizationId) {
                                return [2 /*return*/, optimizedOptions];
                            }
                            return [4 /*yield*/, this.marketContextService.getMarketContext(organizationId)];
                        case 1:
                            marketContext = _b.sent();
                            isNetworkAwareEnabled = marketContext.features.networkAwareComponents;
                            // If network awareness is not enabled, return original options
                            if (!isNetworkAwareEnabled) {
                                return [2 /*return*/, optimizedOptions];
                            }
                            connectionQuality = networkQuality.connectionQuality || networkQuality.quality;
                            if (connectionQuality === 'low' || this.loadSheddingActive) {
                                // For poor connections or during load shedding
                                optimizedOptions.compressionQuality = image_model_1.CompressionQuality.LOW;
                                optimizedOptions.generateThumbnails = false;
                                // Handle resize option safely
                                if (originalOptions.resizeOption === image_model_1.ResizeOption.LARGE) {
                                    optimizedOptions.resizeOption = image_model_1.ResizeOption.MEDIUM;
                                }
                                ...
                                optimizedOptions.compressionQuality = image_model_1.CompressionQuality.MEDIUM;
                                ...
                                optimizedOptions.compressionQuality = optimizedOptions.compressionQuality || image_model_1.CompressionQuality.ADAPTIVE;
         ...
         */
        NetworkAwareStorageService_1.prototype.getCurrentNetworkStatus = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        NetworkAwareStorageService_1.prototype.getNetworkQuality = function () {
            ...
            return __assign(__assign({}, this.networkStatus), { quality: this.networkStatus.connectionQuality });
        };
