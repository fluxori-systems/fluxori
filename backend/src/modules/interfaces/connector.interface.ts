...
export interface IMarketplaceConnector<TProduct, TOrder, TAcknowledgment> extends IConnector {
   ...
   */
  getProducts(options?: PaginationOptions): Promise<PaginatedResponse<TProduct>>;
   ...
   * @param options Pagination options
   */
  getRecentOrders?(sinceDate: Date, options?: PaginationOptions): Promise<PaginatedResponse<TOrder>>;
