...
var FirebaseAuthService = function () {
    ...
    var FirebaseAuthService = _classThis = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.firebaseApp.auth().verifyIdToken(idToken)];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_1 = _a.sent();
                            this.logger.error("Invalid Firebase ID token: ".concat(error_1.message));
         ...
         */
        FirebaseAuthService_1.prototype.createUser = function (email, password, displayName) {
            return __awaiter(this, void 0, void 0, function () {
                var error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.firebaseApp.auth().createUser({
                                    email: email,
                                    password: password,
                        ...
                        case 2:
                            error_2 = _a.sent();
                            this.logger.error("Failed to create user: ".concat(error_2.message));
                            throw error_2;
                        case 3: return [2 /*return*/];
                    }
                });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_3 = _a.sent();
                            this.logger.error("Failed to get user by UID: ".concat(error_3.message));
                            throw error_3;
                        case 3: return [2 /*return*/];
                    }
                });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.firebaseApp.auth().getUserByEmail(email)];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_4 = _a.sent();
                            this.logger.error("Failed to get user by email: ".concat(error_4.message));
                            throw error_4;
                        case 3: return [2 /*return*/];
                    }
                });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.firebaseApp.auth().updateUser(uid, updateData)];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_5 = _a.sent();
                            this.logger.error("Failed to update user: ".concat(error_5.message));
                            throw error_5;
                        case 3: return [2 /*return*/];
                    }
                });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_6 = _a.sent();
                            this.logger.error("Failed to delete user: ".concat(error_6.message));
                            throw error_6;
                        case 3: return [2 /*return*/];
                    }
                });
         ...
         */
        FirebaseAuthService_1.prototype.setCustomUserClaims = function (uid, claims) {
            return __awaiter(this, void 0, void 0, function () {
                var error_7;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.firebaseApp.auth().setCustomUserClaims(uid, claims)];
                        case 1:
                            _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
                            error_7 = _a.sent();
                            this.logger.error("Failed to set custom claims: ".concat(error_7.message));
                            throw error_7;
                        case 3: return [2 /*return*/];
                    }
                });
         ...
         */
        FirebaseAuthService_1.prototype.createCustomToken = function (uid, additionalClaims) {
            return __awaiter(this, void 0, void 0, function () {
                var error_8;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_8 = _a.sent();
                            this.logger.error("Failed to create custom token: ".concat(error_8.message));
                            throw error_8;
                        case 3: return [2 /*return*/];
                    }
                });
