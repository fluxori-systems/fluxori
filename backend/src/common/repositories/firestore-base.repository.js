...
var FirestoreBaseRepository = (function () {
  ...
  var FirestoreBaseRepository = (_classThis = /** @class */ (function () {
     ...
     */
    function FirestoreBaseRepository_1(
      ...
      this.useSoftDeletes =
        (_a = mergedOptions.useSoftDeletes) !== null && _a !== void 0
          ? _a
          : true;
      this.useVersioning =
        (_b = mergedOptions.useVersioning) !== null && _b !== void 0
          ? _b
          : true;
      this.requiredFields =
        (_c = mergedOptions.requiredFields) !== null && _c !== void 0 ? _c : [];
      // Initialize cache if enabled
      this.cache = new base_1.RepositoryCache({
        enabled:
          (_d = mergedOptions.enableCache) !== null && _d !== void 0
            ? _d
            : false,
        ttlMs:
          (_e = mergedOptions.cacheTTLMs) !== null && _e !== void 0
            ? _e
            : 60000,
        maxItems: 100,
        logger: this.logger,
      ...
      this.logger.log(
        'Repository initialized for collection: '.concat(this.collectionName),
      );
    }
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
              ...
              if (!options.bypassCache && this.cache.has(id)) {
                ...
                if (cachedEntity) {
                  ...
                  if (
                    ...
                    (0, base_1.isEntityDeleted)(cachedEntity)
                  ) {
            ...
            case 2:
              return [
                4 /*yield*/,
                this.getDocRef(id).withConverter(this.converter).get(),
              ];
            case 3:
              docSnapshot = _a.sent();
            ...
            case 4:
              ...
              if (
                !options.includeDeleted &&
                (0, base_1.isEntityDeleted)(entity)
              ) {
                return [2 /*return*/, null];
              }
              // Add to cache
        ...
        return __generator(this, function (_g) {
          switch (_g.label) {
            case 0:
              ...
              if (options.filter) {
                for (
                  _i = 0, _a = Object.entries(options.filter);
                  _i < _a.length;
                  _i++
                ) {
              ...
              if (
                ...
                options.advancedFilters.length > 0
              ) {
                for (
                  _c = 0, _d = options.advancedFilters;
                  _c < _d.length;
                  _c++
                ) {
                  filter = _d[_c];
            ...
            case 3:
              ...
              _g.label = 4;
            case 4:
              results = querySnapshot.docs.map(function (doc) {
                return doc.data();
              });
              // Apply offset (since Firestore doesn't support native offset)
              if (
                ((_f = options.queryOptions) === null || _f === void 0
                  ? void 0
                  : _f.offset) &&
                options.queryOptions.offset > 0
              ) {
            ...
            case 5:
              ...
              this.logger.error(
                'Error finding documents: '.concat(error_2.message),
                error_2.stack,
              );
              throw error_2;
            case 6:
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            ...
            case 8:
              ...
              this.logger.error(
                'Error counting documents: '.concat(error_3.message),
                error_3.stack,
              );
              throw error_3;
            case 9:
          ...
          switch (_a.label) {
            case 0:
              ...
              if (options.useServerTimestamp) {
                entityData = (0, base_1.applyServerTimestamps)(
                  entityData,
                  this.serverTimestamp,
                  true,
                );
              } else {
                entityData = (0, base_1.applyClientTimestamps)(
                  entityData,
                  true,
                );
              }
              ...
              return [3 /*break*/, 3];
            case 1:
              return [4 /*yield*/, docRef.set(entityData)];
            case 2:
              _a.sent();
            ...
            case 4:
              ...
              this.logger.error(
                'Error creating document: '.concat(error_4.message),
                error_4.stack,
              );
              throw error_4;
            case 5:
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!options.bypassSoftDeleteCheck && existingDoc.isDeleted) {
                throw new Error(
                  'Cannot update soft-deleted document with id '.concat(id),
                );
              }
              ...
              return [
                2 /*return*/,
                __assign(__assign(__assign({}, existingDoc), updateData), {
                  id: id,
                }),
              ];
            case 2:
            ...
            case 5:
              ...
              if (!updatedDoc) {
                throw new Error(
                  'Failed to retrieve updated document with id '.concat(id),
                );
              }
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 7:
              ...
              this.logger.error(
                'Error deleting document with id '
                  .concat(id, ': ')
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              _loop_1 = function (i) {
                ...
                batches.push(function (batch) {
                  for (
                    var _i = 0, batchItems_1 = batchItems;
                    _i < batchItems_1.length;
                    _i++
                  ) {
                    var item = batchItems_1[_i];
                    // Validate required fields
                    if (_this.requiredFields.length > 0) {
                      (0, base_1.validateRequiredFields)(
                        item,
                    ...
                    if (options.useServerTimestamp) {
                      entityData = (0, base_1.applyServerTimestamps)(
                        entityData,
                        _this.serverTimestamp,
                        true,
                      );
                    } else {
                      entityData = __assign(__assign({}, entityData), {
                        createdAt: now_1,
                        updatedAt: now_1,
                      });
                    }
                    ...
                    createdEntities_2.push(
                      __assign({ id: docRef.id }, entityData),
                    );
                  }
                });
              };
              ...
              return [
                4 /*yield*/,
                (0, base_1.executeMultiBatch)(this.firestore, batches),
              ];
            case 1:
              result = _a.sent();
              // Track stats
              (0, base_1.incrementWrites)(
                this.statsTracker,
              ...
              if (options.addToCache !== false && result.status !== 'error') {
                for (
                  _i = 0, createdEntities_1 = createdEntities_2;
                  _i < createdEntities_1.length;
                  _i++
                ) {
            ...
            case 2:
              ...
              this.logger.error(
                'Error creating batch: '.concat(error_7.message),
                error_7.stack,
              );
              throw error_7;
            case 3:
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              this.logger.error(
                'Error executing transaction: '.concat(error_8.message),
                error_8.stack,
              );
              throw error_8;
            case 3:
    ...
    FirestoreBaseRepository_1.prototype.withTransaction = function (fn) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            this.runTransaction(function (context) {
              return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        return __generator(this, function (_j) {
          switch (_j.label) {
            case 0:
              _j.trys.push([0, 2, , 3]);
              page =
                ((_c = queryOptions.pagination) === null || _c === void 0
                  ? void 0
                  : _c.page) || 1;
              pageSize =
                ((_d = queryOptions.pagination) === null || _d === void 0
                  ? void 0
                  : _d.pageSize) || 10;
              ...
              itemsPromise = this.find({
                ...
                queryOptions: {
                  ...
                  orderBy:
                    (_f =
                      (_e = queryOptions.orderBy) === null || _e === void 0
                        ? void 0
                        : _e[0]) === null || _f === void 0
                      ? void 0
                      : _f.field,
                  direction:
                    (_h =
                      (_g = queryOptions.orderBy) === null || _g === void 0
                        ? void 0
                        : _g[0]) === null || _h === void 0
                      ? void 0
                      : _h.direction,
            ...
            case 2:
              ...
              this.logger.error(
                'Error paginating documents: '.concat(error_9.message),
                error_9.stack,
              );
              throw error_9;
            case 3:
...
var TenantAwareRepository = (function () {
  ...
  var TenantAwareRepository = (_classThis = /** @class */ (function (_super) {
     ...
     */
    TenantAwareRepository_1.prototype.findByOrganization = function (
      organizationId_1,
    ) {
      return __awaiter(
        this,
        arguments,
        void 0,
        function (organizationId, options) {
          var filter;
          if (options === void 0) {
            options = {};
          }
          return __generator(this, function (_a) {
            filter = __assign(__assign({}, options.filter), {
              organizationId: organizationId,
            });
            return [
              2 /*return*/,
              this.find(__assign(__assign({}, options), { filter: filter })),
            ];
          });
        },
      );
     ...
     */
    TenantAwareRepository_1.prototype.countByOrganization = function (
      organizationId_1,
    ) {
      return __awaiter(
        this,
        ...
        function (organizationId, options) {
          ...
          return __generator(this, function (_a) {
            ...
            return [
              2 /*return*/,
              this.count(__assign(__assign({}, options), { filter: filter })),
            ];
          });
        },
      );
     ...
     */
    TenantAwareRepository_1.prototype.paginateByOrganization = function (
      organizationId_1,
    ) {
      return __awaiter(
        this,
        arguments,
        void 0,
        function (organizationId, queryOptions) {
          var filters;
          if (queryOptions === void 0) {
            queryOptions = {};
          }
          return __generator(this, function (_a) {
            filters = __spreadArray(
              __spreadArray([], queryOptions.filters || [], true),
              [
                {
            ...
            return [
              2 /*return*/,
              this.paginate(
                __assign(__assign({}, queryOptions), { filters: filters }),
              ),
            ];
          });
        },
