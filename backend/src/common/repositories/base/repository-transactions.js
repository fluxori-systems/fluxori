...
function executeTransaction(firestore_1, executionFunction_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function (firestore, executionFunction, options) {
      var mergedOptions,
        logger,
        attempts,
        lastError,
        ...
        switch (_a.label) {
          case 0:
            mergedOptions = __assign(
              __assign({}, exports.DEFAULT_TRANSACTION_OPTIONS),
              options,
            );
          ...
          case 7:
            ...
            logger.debug(
              'Transaction attempt '
                .concat(attempts, '/')
                .concat(mergedOptions.maxAttempts, ' failed: ')
...
function executeBatch(firestore_1, operations_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function (firestore, operations, batchSize) {
      var batch, error_2;
      if (batchSize === void 0) {
        batchSize = 500;
      }
...
function executeMultiBatch(firestore_1, batches_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function (firestore, batches, batchSize) {
      var results,
        i,
        batchOperation,
        result,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              executeBatch(firestore, batchOperation, batchSize),
            ];
          case 2:
            result = _a.sent();
            results.push(result);
