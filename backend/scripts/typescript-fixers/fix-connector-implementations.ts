...
const filesToFix = [
  path.resolve(__dirname, '../../src/modules/connectors/adapters/takealot-connector.ts'),
  path.resolve(__dirname, '../../src/modules/connectors/adapters/amazon-sp/amazon-sp-connector.ts'),
  path.resolve(__dirname, '../../src/modules/connectors/adapters/shopify/shopify-connector.ts')
];
