...
var FeatureFlagRepository = (function () {
  ...
  var FeatureFlagRepository = (_classThis = /** @class */ (function (_super) {
    ...
    function FeatureFlagRepository_1(firestoreConfigService) {
      var _this =
        _super.call(this, firestoreConfigService, "feature_flags", {
          enableCache: true,
     ...
     */
    FeatureFlagRepository_1.prototype.findByEnvironment = function (
      environment,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            case 1:
              ...
              return [
                ...
                allFlags.filter(function (flag) {
                  return flag.tags && flag.tags.includes(tag);
                }),
              ];
          }
        });
     ...
     */
    FeatureFlagRepository_1.prototype.findByOrganization = function (
      organizationId,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                2 /*return*/,
                orgTargetedFlags.filter(function (flag) {
                  if (!flag.organizationTargeting) return false;
                  var organizationIds =
                    flag.organizationTargeting.organizationIds;
                  return (
                    organizationIds && organizationIds.includes(organizationId)
                  );
                }),
              ];
          }
     ...
     */
    FeatureFlagRepository_1.prototype.findByUser = function (
      userId,
      userRole,
      userEmail,
    ) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
                  ...
                  advancedFilters: [
                    {
                      field: "type",
                      operator: "==",
                      value: types_1.FeatureFlagType.USER_TARGETED,
                    },
                  ],
                }),
              ];
            case 1:
              ...
              return [
                2 /*return*/,
                userTargetedFlags.filter(function (flag) {
                  if (!flag.userTargeting) return false;
                  var _a = flag.userTargeting,
                    userIds = _a.userIds,
