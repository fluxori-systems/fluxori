...
var AgentService = (function () {
  ...
  var AgentService = (_classThis = /** @class */ (function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.agentConfigRepository.findById(request.agentConfigId),
              ];
            case 1:
              agentConfig = _a.sent();
              if (!agentConfig) {
                throw new Error(
                  "Agent configuration not found: ".concat(
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.conversationRepository.findById(request.conversationId),
              ];
            case 1:
              conversation = _a.sent();
              if (!conversation) {
                throw new Error(
                  "Conversation not found: ".concat(request.conversationId),
                );
              }
              ...
              return [
                4 /*yield*/,
                this.agentConfigRepository.findById(conversation.agentConfigId),
              ];
            case 2:
              agentConfig = _a.sent();
              if (!agentConfig) {
              ...
              if (!agentEnabled) {
                return [
                  2 /*return*/,
                  {
                    ...
                    content: "Agent '".concat(
                      agentConfig.name,
                      "' is no longer available for your organization.",
                    ),
            ...
            case 5:
              error_2 = _a.sent();
              this.logger.error(
                "Error sending message: ".concat(error_2.message),
                error_2.stack,
              );
              throw new Error(
                "Failed to send message: ".concat(error_2.message),
              );
            case 6:
              return [2 /*return*/];
          }
     ...
     */
    AgentService_1.prototype.getConversation = function (
      conversationId,
      userId,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!conversation) {
                throw new Error(
                  "Conversation not found: ".concat(conversationId),
                );
              }
              // Verify user has access to the conversation
            ...
            case 2:
              error_3 = _a.sent();
              this.logger.error(
                "Error fetching conversation: ".concat(error_3.message),
                error_3.stack,
              );
              throw new Error(
                "Failed to fetch conversation: ".concat(error_3.message),
              );
            case 3:
              return [2 /*return*/];
          }
     ...
     */
    AgentService_1.prototype.listUserConversations = function (
      organizationId_1,
      userId_1,
    ) {
      return __awaiter(
        ...
        arguments,
        void 0,
        function (organizationId, userId, limit) {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  this.conversationRepository.findByUser(
                    organizationId,
                    userId,
                    limit,
                  ),
              ...
              case 2:
                error_4 = _a.sent();
                this.logger.error(
                  "Error listing conversations: ".concat(error_4.message),
                  error_4.stack,
                );
                throw new Error(
                  "Failed to list conversations: ".concat(error_4.message),
                );
              case 3:
                return [2 /*return*/];
            }
     ...
     */
    AgentService_1.prototype.getAgentConfigurations = function (
      organizationId,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.agentConfigRepository.findByOrganization(organizationId),
              ];
            case 1:
              configs = _a.sent();
              filteredConfigs = [];
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                this.checkAgentFeatureFlag(config.name, organizationId),
              ];
            case 3:
              isEnabled = _a.sent();
              if (isEnabled) {
            ...
            case 4:
              ...
              return [3 /*break*/, 2];
            case 5:
              return [2 /*return*/, filteredConfigs];
            case 6:
              error_5 = _a.sent();
              this.logger.error(
                "Error fetching agent configurations: ".concat(error_5.message),
                error_5.stack,
              );
              throw new Error(
                "Failed to fetch agent configurations: ".concat(
                  error_5.message,
                ),
              );
            case 7:
     ...
     * @private
     */
    AgentService_1.prototype.processAgentResponse = function (
      conversationId,
      overrideModel,
    ) {
      return __awaiter(this, void 0, void 0, function () {
          ...
          switch (_a.label) {
            ...
            case 3:
              ...
              model = allModels.find(function (m) {
                return m.model === modelName_1 && m.isEnabled;
              });
              if (!model) {
              ...
              return [
                4 /*yield*/,
                adapter.generateChatCompletion(model, chatRequest),
              ];
            case 4:
              response = _a.sent();
            ...
            case 5:
              ...
              return [
                ...
                this.conversationRepository.update(conversation.id, {
                  tokensUsed:
                    conversation.tokensUsed + response.usage.totalTokens,
            ...
            case 7:
              error_6 = _a.sent();
              this.logger.error(
                "Error processing agent response: ".concat(error_6.message),
                error_6.stack,
              );
              throw new Error(
                "Failed to process agent response: ".concat(error_6.message),
              );
            case 8:
              return [2 /*return*/];
          }
     ...
     */
    AgentService_1.prototype.getBestModelForTask = function (
      organizationId,
      complexity,
      preferredProvider,
      ...
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          try {
            return [
              2 /*return*/,
              this.modelRegistryRepository.findBestModelForTask({
            ...
            this.logger.error(
              "Error finding model for task: ".concat(error.message),
              error.stack,
            );
            throw new Error(
              "Failed to find model for task: ".concat(error.message),
            );
          }
          return [2 /*return*/];
        });
     ...
     */
    AgentService_1.prototype.archiveOldConversations = function (
      organizationId_1,
      userId_1,
    ) {
      return __awaiter(
        ...
        arguments,
        void 0,
        function (organizationId, userId, keepActive) {
          ...
          return __generator(this, function (_a) {
            try {
              return [
                2 /*return*/,
                this.conversationRepository.archiveOldUserConversations(
                  organizationId,
                  userId,
                  keepActive,
                ),
              ...
              this.logger.error(
                "Error archiving conversations: ".concat(error.message),
                error.stack,
              );
              throw new Error(
                "Failed to archive conversations: ".concat(error.message),
              );
            }
            return [2 /*return*/];
          });
     ...
     * @private
     */
    AgentService_1.prototype.checkAgentFeatureFlag = function (
      agentName,
      organizationId,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.featureFlagService.isEnabled(flagKey, {
            ...
            case 3:
              ...
              this.logger.warn(
                "Error checking feature flag for agent "
                  .concat(agentName, ": ")
                  .concat(error_7.message),
              );
