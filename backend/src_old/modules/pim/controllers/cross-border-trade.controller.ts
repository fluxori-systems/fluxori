...
export class CrossBorderTradeController {
  ...
  async isCrossBorderTradeEnabled(
    ...
    try {
      const enabled =
        await this.crossBorderTradeService.isCrossBorderTradeEnabled(
          organizationId,
        );
      return { enabled };
    } catch (error) {
      this.logger.error(
        `Error checking cross-border trade enabled: ${error.message}`,
        error.stack,
      );
  ...
  async getRegionalTradeAgreements(): Promise<RegionalTradeAgreement[]> {
    try {
      ...
      this.logger.error(
        `Error getting regional trade agreements: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async getTradeAgreementByCode(
    ...
    try {
      const agreement =
        await this.crossBorderTradeService.getTradeAgreementByCode(code);
      ...
      this.logger.error(
        `Error getting trade agreement: ${error.message}`,
        error.stack,
      );
  ...
  async getApplicableTradeAgreements(
    ...
    try {
      ...
      this.logger.error(
        `Error getting applicable trade agreements: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async calculateDutiesAndTaxes(
    ...
    try {
      return await this.crossBorderTradeService.calculateDutiesAndTaxes(
        request,
      );
    } catch (error) {
      this.logger.error(
        `Error calculating duties and taxes: ${error.message}`,
        error.stack,
      );
  ...
  async getShippingEstimates(
    ...
    try {
      ...
      this.logger.error(
        `Error getting shipping estimates: ${error.message}`,
        error.stack,
      );
  ...
  async getProductCustomsInfo(
    ...
    try {
      return await this.crossBorderTradeService.getProductCustomsInfo(
        productId,
        organizationId,
      );
    } catch (error) {
      this.logger.error(
        `Error getting product customs info: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async updateProductCustomsInfo(
    ...
    try {
      ...
      this.logger.error(
        `Error updating product customs info: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
  ...
  async createCrossBorderShipment(
    ...
    try {
      ...
      this.logger.error(
        `Error creating cross-border shipment: ${error.message}`,
        error.stack,
      );
  ...
  async checkProductShippingEligibility(
    ...
    try {
      ...
      this.logger.error(
        `Error checking product shipping eligibility: ${error.message}`,
        error.stack,
      );
  ...
  async getCountryProductRestrictions(
    ...
    try {
      ...
      this.logger.error(
        `Error getting country product restrictions: ${error.message}`,
        error.stack,
      );
      throw new HttpException(
