...
export class ProductService {
  ...
  async findByBundleId(
    ...
    try {
      ...
      this.logger.error(
        `Error finding product by bundle ID: ${error.message}`,
        error.stack,
      );
      throw error;
    }
   ...
   */
  async findBundlesContainingProduct(
    productId: string,
    organizationId: string,
  ): Promise<Product[]> {
    try {
      ...
      this.logger.error(
        `Error finding bundles containing product: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async create(product: Product, organizationId: string): Promise<Product> {
    try {
      ...
      this.logger.error(
        `Error creating product directly: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async update(
    ...
    try {
      ...
      this.logger.error(
        `Error updating product directly: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async findProducts(
    ...
    try {
      this.logger.log(
        `Finding products with filter: ${JSON.stringify(filter)}`,
      );
  ...
  async getFeaturedProducts(
    ...
    try {
      this.logger.log(
        `Getting featured products for organization ${organizationId}`,
      );
  ...
  async getRecentlyUpdatedProducts(
    ...
    try {
      this.logger.log(
        `Getting recently updated products for organization ${organizationId}`,
      );

      const products = await this.productRepository.findRecentlyUpdated(
        organizationId,
        limit,
      );
      ...
      this.logger.error(
        `Error getting recently updated products: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async getProductsByCategory(
    ...
    try {
      this.logger.log(
        `Getting products for category ${categoryId} (includeSubcategories: ${includeSubcategories})`,
      );
      ...
      this.logger.error(
        `Error getting products by category: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async getProductsByMarketplace(
    ...
    try {
      ...
      this.logger.error(
        `Error getting products by marketplace: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async getProductsBySkus(
    ...
    try {
      ...
      this.logger.error(
        `Error getting products by SKUs: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async bulkUpdateProducts(
    operations: Array<{ id: string; updates: UpdateProductDto }>,
