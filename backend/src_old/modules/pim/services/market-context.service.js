...
var MarketContextService = (function () {
  ...
  var MarketContextService = (_classThis = /** @class */ (function () {
     ...
     */
    function MarketContextService_1(
      featureFlagService,
     ...
     */
    MarketContextService_1.prototype.getMarketContext = function (
      organizationId,
    ) {
     ...
     * @returns The market context
     */
    MarketContextService_1.prototype.getMarketContextByRegion = function (
      region,
      country,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              regionalFeatures =
                ((_a = this.options.regionalFeatures) === null || _a === void 0
                  ? void 0
                  : _a[region]) || {};
     ...
     */
    MarketContextService_1.prototype.isFeatureAvailable = function (
      feature,
      context,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              featureFlagKey = "pim."
                .concat(context.region, ".")
                .concat(feature);
              return [
                4 /*yield*/,
                this.featureFlagService.isEnabled(featureFlagKey, {
    ...
    MarketContextService_1.prototype.getAvailableRegions = function () {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
            2 /*return*/,
            __spreadArray([], this.options.enabledRegions, true),
          ];
        });
      });
    };
     ...
     */
    MarketContextService_1.prototype.getDefaultCountryForRegion = function (
      region,
    ) {
      var countryMap = {
        "south-africa": "za",
