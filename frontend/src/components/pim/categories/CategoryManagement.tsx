...
export default function CategoryManagement() {
  ...
  const handleDeleteCategory = async () => {
    ...
    if (
      ...
      alert(
        `Cannot delete category with ${selectedCategory.productCount} products. Please reassign products first.`,
      );
      return;
    }
    ...
    if (
      ...
      try {
        ...
        alert(
          "Failed to delete category. It may have subcategories that need to be deleted first.",
        );
      }
    }
  };
