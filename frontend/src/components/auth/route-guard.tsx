...
export default function RouteGuard({ 
  ...
  useEffect(() => {
    ...
    if (organizationRequired && !user?.organizationId) {
      ...
      router.push(`/create-organization?redirect=${encodeURIComponent(window.location.pathname)}`);
      return;
    }
  ...
  }, [isLoading, isAuthenticated, user, requiredPermissions, organizationRequired, router, hasPermission]);
