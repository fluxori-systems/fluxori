...
export function SAProductCard({
  ...
  const shouldSimplify =
    forceDataSaver || isDataSaver || quality === "poor" || quality === "low";
  ...
  const formattedOriginalPrice = originalPrice
    ? formatCurrency(originalPrice, "ZAR")
    : "";
  ...
  const getShippingText = () => {
    ...
    const methodText = shippingMethods
      .map((method) =>
        method === "standard"
          ? "Standard"
          : method === "express"
  ...
  if (shouldSimplify) {
    ...
    return (
      ...
      >
        <Text preset="heading4" fw={600} style={{ marginBottom: 8 }}>
          {title}
        </Text>
        ...
        >
          <Text preset="heading5" intent="primary">
            {formattedPrice}
          </Text>
          {discountPercentage && (
            <Text intent="error" span fw={500}>
  ...
  return (
    ...
    >
      {imageUrl && (
        <div
          className="sa-product-card-image-container"
      ...
      >
        <div>
          <Text preset="heading3" intent="primary">
            {formattedPrice}
          </Text>
          {originalPrice && (
