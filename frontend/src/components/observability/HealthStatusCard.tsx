  ...
  const renderComponentStatus = (component: HealthCheckResult) => (
    ...
    >
      <div className="flex items-center">
        <div
          className={`w-3 h-3 rounded-full mr-2 ${getStatusColor(component.status)}`}
        ></div>
  ...
  return (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        ...
        <div className="flex items-center">
          <div
            className={`w-4 h-4 rounded-full mr-2 ${getStatusColor(healthInfo.status)}`}
          ></div>
      ...
      <div className="p-4">
        ...
        {detailed &&
          healthInfo.components &&
          healthInfo.components.length > 0 && (
            <div>
