...
const NetworkDemo = () => {
  ...
  const getQualityColor = (quality: ConnectionQuality) => {
    switch (quality) {
      case 'high': return 'var(--color-success-base)';
      case 'medium': return 'var(--color-info-base)';
      case 'low': return 'var(--color-warning-base)';
      case 'poor': return 'var(--color-error-base)';
      default: return 'var(--color-info-base)';
    }
  };
  ...
  return (
    <ConnectionQualitySimulator initialProfile="south-africa-urban">
      ...
      <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
        <h2 className="text-xl font-semibold mb-4">Network-Aware UI Components</h2>
        <p className="mb-4 text-gray-600">
          These components automatically adapt based on network conditions and motion preferences.
          Try changing the motion settings above and see how the components behave.
        </p>
        ...
        <div className="grid grid-cols-2 gap-6 mt-6">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="font-medium mb-2">Buttons with Different Animation Types</h3>
        ...
        <div className="grid grid-cols-2 gap-6 mt-8">
          <div className="flex flex-col gap-4">
            <h3 className="font-medium mb-2">Form Fields with Network Awareness</h3>
            <p className="text-sm text-gray-600 mb-2">
              These form fields adapt to network conditions. On poor connections or with data saver enabled:
      ...
      <div className="p-6 bg-white rounded-lg shadow-md mb-8">
        ...
        <p className="mb-4 text-gray-600">
          These buttons monitor their own performance and adapt animations based on device capabilities
          and network conditions. The buttons showing metrics display their animation duration in ms.
        </p>
        
        <div className="grid grid-cols-2 gap-6 mt-6">
          <div className="flex flex-col gap-3">
            <h3 className="font-medium mb-2">Performance Buttons (with metrics)</h3>
            <PerformanceButton 
      ...
      <div className="p-6 bg-white rounded-lg shadow-md">
        <h2 className="text-xl font-semibold mb-4">Network Adaptation Explained</h2>
        <div className="prose">
          <ul>
            <li><strong>High Quality Connection:</strong> Full animations, rich effects, parallax scrolling</li>
            <li><strong>Medium Quality Connection:</strong> Slightly reduced animation complexity, standard effects</li>
            <li><strong>Low Quality Connection:</strong> Simplified animations, reduced motion, static backgrounds</li>
            <li><strong>Poor Connection:</strong> Minimal animations, static UI, simplified layouts</li>
            <li><strong>Data Saver Mode:</strong> Treated as poor connection with additional optimizations</li>
          </ul>
        </div>
      </div>
    </div>
