...
function RegisterContent() {
  ...
  const { register: registerUser, loginWithGoogle, checkEmailExists, isLoading: authLoading } = useFirebase();
  ...
  const handleRegister = async (data: RegistrationData) => {
    ...
    try {
      ...
      await registerUser(data.email, data.password, data.name, orgName, inviteToken || undefined);
    ...
    <Container size="md" py="xl">
      <Box pos="relative">
        ...
        <Paper radius="md" p="xl" withBorder>
          <Center mb="md">
            <Box w={180}>
              <Title order={2} ta="center">Fluxori</Title>
            </Box>
          </Center>
          ...
          <form onSubmit={handleSubmit(handleRegister)}>
            <Stepper active={activeStep} onStepClick={setActiveStep} allowNextStepsSelect={false}>
              <Stepper.Step label="Account" description="Create account" icon={<IconUser size={18} />}>
                <Stack mt="md">
                  <TextInput
                    label="Full Name"
                ...
                <Stack mt="md">
                    ...
                    <>
                      <TextInput
                        ...
                        {...register('organizationName', {
                          required: createOrg ? 'Organization name is required' : false,
                          minLength: {
                            value: 2,
                            message: 'Name must be at least 2 characters',
                          },
                      ...
                      <Select
                        ...
                        data={[
                          ...
                          { value: IndustrySector.WHOLESALE, label: 'Wholesale' },
                          { value: IndustrySector.MANUFACTURING, label: 'Manufacturing' },
                          { value: IndustrySector.SERVICES, label: 'Services' },
                          { value: IndustrySector.TECHNOLOGY, label: 'Technology' },
                          { value: IndustrySector.OTHER, label: 'Other' },
                        ]}
                        value={getValues('industry')}
                        onChange={(val) => setValue('industry', val || IndustrySector.RETAIL)}
                      />
                    </>
                  )}
                  ...
                  <Checkbox
                    ...
                    label={
                      <Text size="sm">
                        I agree to the{' '}
                        <Anchor href="#" target="_blank" size="sm">Terms of Service</Anchor>
                        {' '}and{' '}
                        <Anchor href="#" target="_blank" size="sm">Privacy Policy</Anchor>
                      </Text>
                    }
            ...
            <Group justify="space-between" mt="xl">
              ...
              {activeStep < 2 ? (
                ...
                <Button type="submit" c="green" ml="auto" disabled={!isValid || !getValues('agreeToTerms')}>
                  Register
                </Button>
              )}
            </Group>
    ...
    <Suspense fallback={
      <Container size="md" py="xl">
        <Paper radius="md" p="xl" withBorder>
          ...
          <Text ta="center" mt="md">Loading...</Text>
        </Paper>
      </Container>
    }>
      <RegisterContent />
