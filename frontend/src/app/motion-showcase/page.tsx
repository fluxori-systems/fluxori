...
function MotionControls() {
  const { motionMode, setMotionMode, prefersReducedMotion, isLowBandwidth } =
    useMotion();
          ...
          style={{
            ...
            background:
              motionMode === "full"
                ...
                : "transparent",
            color:
              motionMode === "full" ? "white" : "var(--color-text-primary)",
            cursor: "pointer",
          }}
        >
          Full Motion
          ...
          style={{
            ...
            background:
              motionMode === "reduced"
                ...
                : "transparent",
            color:
              motionMode === "reduced" ? "white" : "var(--color-text-primary)",
            cursor: "pointer",
          }}
        >
          Reduced Motion
          ...
          style={{
            ...
            background:
              motionMode === "minimal"
                ...
                : "transparent",
            color:
              motionMode === "minimal" ? "white" : "var(--color-text-primary)",
            cursor: "pointer",
          }}
        >
          Minimal Motion
...
function AIAnimations() {
  ...
  const [confidenceLevel, setConfidenceLevel] = useState<
    "low" | "medium" | "high" | "verifying" | "processing"
  >("medium");
  ...
  const toggleProcessing = (
    state: "idle" | "thinking" | "processing" | "analyzing",
  ) => {
    ...
    <ShowcaseSection title="AI-Specific Animations">
      <div style={{ marginBottom: "2rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          <AIProcessingIndicator state={processingState} size={40} />
          <div>
            {processingState !== "idle"
              ? `AI is ${processingState}...`
              : "Idle state"}
          </div>
        </div>
      </div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          <IconFeedback
            ...
            size={40}
          />
          <div>{`Showing ${confidenceLevel} confidence feedback`}</div>
        </div>
      </div>
        ...
        {showContent && (
          <TransitionFade direction="up" duration={0.4}>
            ...
            >
              ...
              <p style={{ margin: 0 }}>
                This content animates in and out smoothly when toggled. The
                TransitionFade component respects reduced motion preferences.
              </p>
            </div>
          </TransitionFade>
        )}
...
function GSAPTimelineDemo() {
  ...
  const playTimeline = () => {
    ...
    const duration =
      durations.normal *
      (motionMode === "minimal" ? 0.5 : motionMode === "reduced" ? 0.7 : 1);
...
function BusinessAnimations() {
  ...
  const runSVGDemo = () => {
    ...
    try {
      ...
      // Fallback animation
      gsap.fromTo(svgRef.current, { opacity: 0 }, { opacity: 1, duration: 1 });
    }
  };
  ...
  return (
    <ShowcaseSection title="GSAP Business Features">
      <div style={{ marginBottom: "1.5rem" }}>
        ...
        <p>
          These features require a valid GSAP Business license. Module
          installation token is active.
        </p>
      </div>
  ...
  return (
    <MotionProvider>
      ...
      >
        ...
        <p>
          This showcase demonstrates the capabilities of the Fluxori Motion
          Framework, which provides consistent, performant animations throughout
          the application.
        </p>
