      ...
      <Container size="sm" my="xl">
        <Paper p="xl" shadow="md" withBorder>
          ...
          <Text ta="center" mt="lg">
            You are currently a member of an organization and cannot create or join another one.
          </Text>
          <Center mt="xl">
    ...
    <Container size="sm" my="xl">
      <Paper shadow="md" p="xl" withBorder>
        ...
        <Text c="dimmed" size="sm" ta="center" mb="xl">
          ...
          You can either create a new one or join an existing one via invitation.
        </Text>
