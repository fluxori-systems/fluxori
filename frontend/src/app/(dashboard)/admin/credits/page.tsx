      ...
      <Stack gap="xl">
        ...
        <Card shadow="sm" p="lg" withBorder>
          <Title order={3} size="h4" mb="xl">
            Organization Credit Allotments
          </Title>
            ...
            <tbody>
              {allotments.map((allotment) => {
                const org = organizations.find(
                  (o) => o.id === allotment.organizationId,
                );
                const usagePercent = Math.round(
                  (allotment.currentUsage / allotment.monthlyLimit) * 100,
                );
                  ...
                  <tr key={allotment.organizationId}>
                    ...
                    <td>
                      <Button
                        size="xs"
                        onClick={() =>
                          handleUpdateAllotment(allotment.organizationId)
                        }
                      >
                        Update
                      </Button>
        ...
        <Card shadow="sm" p="lg" withBorder>
          <Title order={3} size="h4" mb="md">
            Add New Organization Allotment
          </Title>

          <Text mb="lg">
            Create a new credit allotment for an organization that doesn't have
            one yet.
          </Text>
