...
export function SouthAfricanMarketOptimizer({
  ...
  useEffect(() => {
    ...
    const delay =
      saMarket.networkProfile === SANetworkProfile.RURAL ? 300 : 100;
  ...
  return (
    <div id={`sa-optimizer-${component}`} style={style} {...dataAttrs}>
      {children}
    </div>
  );
}
