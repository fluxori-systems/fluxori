...
export function useSouthAfricanPerformance(): SouthAfricanPerformanceData {
  ...
  const detectProfiles = useCallback(() => {
    ...
    if (typeof navigator !== "undefined" && navigator.connection) {
      ...
      networkConditions.downlink =
        capabilities.cpuPerformance === "low" ? 2 : 10;
      networkConditions.rtt = capabilities.cpuPerformance === "low" ? 300 : 100;
      networkConditions.effectiveType =
        capabilities.cpuPerformance === "low" ? "3g" : "4g";
  ...
  if (deviceProfile) {
    ...
    animationRecommendations.maxConcurrentAnimations =
      optimizationRecommendations.maxConcurrentAnimations;
    ...
    animationRecommendations.durationMultiplier =
      optimizationRecommendations.durationMultiplier;
  ...
  if (networkProfile) {
    ...
    networkRecommendations.maxInitialPayloadKB =
      bandwidthRecommendations.maxInitialPageSizeKB;
    networkRecommendations.maxImageSizeKB =
      bandwidthRecommendations.maxImageSizeKB;
    networkRecommendations.shouldPreloadResources =
      bandwidthRecommendations.preloadCriticalResources;
    networkRecommendations.shouldUseLazyLoading =
      bandwidthRecommendations.lazyLoadNonCritical;
    networkRecommendations.shouldUseCompression =
      bandwidthRecommendations.useCompression;
