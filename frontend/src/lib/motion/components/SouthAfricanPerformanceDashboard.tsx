...
export const SouthAfricanPerformanceDashboard: React.FC = () => {
  ...
  const [viewMode, setViewMode] = useState<"insights" | "device" | "network">(
    "insights",
  );
  ...
  const fetchInsights = () => {
    ...
    if (severityFilter !== "all") {
      latestInsights = latestInsights.filter(
        (insight) =>
          getSeverityLevel(insight.severity) >=
          getSeverityLevel(severityFilter as any),
      );
    }
  ...
  const detectProfiles = () => {
    ...
    for (const profile of southAfricanDeviceProfiles) {
      ...
      if (
        (capabilities.memory &&
          profile.memory === Math.floor(capabilities.memory)) ||
    ...
    if (isLowBandwidth) {
      ...
      const profile = southAfricanNetworkProfiles.find(
        (p) => p.locationType === "township" || p.locationType === "rural",
      );
      setNetworkProfile(profile || null);
    } else {
      // Find an urban profile
      const profile = southAfricanNetworkProfiles.find(
        (p) => p.locationType === "urban",
      );
      setNetworkProfile(profile || null);
    }
  };
    ...
    <div className="sa-performance-dashboard">
      <div className="dashboard-header">
        ...
        <div className="device-info">
          {deviceProfile ? (
            <span>
              Detected device type: {deviceProfile.deviceName} (
              {deviceProfile.marketSharePercent.toFixed(1)}% market share)
            </span>
          ) : (
          ...
          {networkProfile && (
            <span>
              {" "}
              · Network: {networkProfile.provider} {networkProfile.networkType}{" "}
              in {networkProfile.locationType} area
            </span>
          )}
        </div>
      ...
      <div className="dashboard-content">
          ...
          <>
            {insights.length === 0 ? (
              <div className="empty-state">
                <p>
                  No performance insights available yet. Run analysis to
                  generate insights.
                </p>
              </div>
            ) : (
                    ...
                    <div className="insight-content">
                      ...
                      <div className="insight-details">
                        <div className="impact-indicator">
                          Impact:{" "}
                          {Array(insight.estimatedImpact).fill("●").join("")}
                          {Array(10 - insight.estimatedImpact)
                            .fill("○")
                            .join("")}
                        </div>
            ...
            <div className="profile-stats">
              <div className="stat-item">
                ...
                <span className="stat-value">
                  {deviceProfile.marketSharePercent.toFixed(1)}%
                </span>
              </div>
              <div className="stat-item">
                <span className="stat-label">Processor tier:</span>
                <span className="stat-value">
                  {deviceProfile.processorTier}
                </span>
              </div>
              <div className="stat-item">
              ...
              <div className="stat-item">
                ...
                <span className="stat-value">
                  {deviceProfile.resolution.width}×
                  {deviceProfile.resolution.height}
                </span>
              </div>
              <div className="stat-item">
              ...
              <div className="stat-item">
                ...
                <span className="stat-value">
                  {deviceProfile.hasGPUAcceleration ? "Yes" : "No"}
                </span>
              </div>
              <div className="stat-item">
                <span className="stat-label">Throttling prone:</span>
                <span className="stat-value">
                  {deviceProfile.throttlingProne ? "Yes" : "No"}
                </span>
              </div>
            </div>
            ...
            <div className="recommendations-list">
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {
                    deviceProfile.optimizationRecommendations
              ...
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {deviceProfile.optimizationRecommendations.disablePhysics
                    ? "Yes"
                    : "No"}
                </span>
              </div>
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {deviceProfile.optimizationRecommendations.useSimpleBezier
                    ? "Yes"
                    : "No"}
                </span>
              </div>
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {deviceProfile.optimizationRecommendations.disableParallax
                    ? "Yes"
                    : "No"}
                </span>
              </div>
              ...
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {deviceProfile.optimizationRecommendations.maxFPS}
                </span>
              </div>
              <div className="recommendation-item">
                <span className="recommendation-label">
                ...
                <span className="recommendation-value">
                  {deviceProfile.optimizationRecommendations.durationMultiplier.toFixed(
                    1,
                  )}
                </span>
              </div>
                    ...
                    <div className="bar-container">
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor:
                            profile.deviceType === deviceProfile.deviceType
                              ? "#007AFF"
                              : "#E5E5EA",
                        }}
                      />
                      <span className="bar-value">
                        {profile.marketSharePercent.toFixed(1)}%
                      </span>
                    </div>
                  </div>
                ))}
        ...
        {viewMode === "network" && networkProfile && (
          <div className="profile-detail">
            <h3>
              Network Profile: {networkProfile.provider}{" "}
              {networkProfile.networkType} in {networkProfile.locationType} area
            </h3>
            ...
            <div className="profile-stats">
              <div className="stat-item">
                ...
                <span className="stat-value">
                  {networkProfile.downloadSpeedMbps.toFixed(1)} Mbps
                </span>
              </div>
              <div className="stat-item">
                <span className="stat-label">Upload speed:</span>
                <span className="stat-value">
                  {networkProfile.uploadSpeedMbps.toFixed(1)} Mbps
                </span>
              </div>
              <div className="stat-item">
                <span className="stat-label">Latency:</span>
                <span className="stat-value">
                  {networkProfile.latencyMs} ms
                </span>
              </div>
              <div className="stat-item">
                <span className="stat-label">Packet loss:</span>
                <span className="stat-value">
                  {networkProfile.packetLossPercent.toFixed(1)}%
                </span>
              </div>
              <div className="stat-item">
              ...
              <div className="stat-item">
                ...
                <span className="stat-value">
                  R{networkProfile.dataCostPerMBZAR.toFixed(3)}/MB
                </span>
              </div>
            </div>
            ...
            <div className="recommendations-list">
              <div className="recommendation-item">
                <span className="recommendation-label">
                  Max initial page size:
                </span>
                <span className="recommendation-value">
                  {networkProfile.bandwidthRecommendations.maxInitialPageSizeKB}{" "}
                  KB
                </span>
              </div>
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {networkProfile.bandwidthRecommendations.maxImageSizeKB} KB
                </span>
              </div>
              <div className="recommendation-item">
                <span className="recommendation-label">
                ...
                <span className="recommendation-value">
                  {networkProfile.bandwidthRecommendations.maxAnimationsDataKB}{" "}
                  KB
                </span>
              </div>
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {
                    networkProfile.bandwidthRecommendations
              ...
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {networkProfile.bandwidthRecommendations.useCompression
                    ? "Yes"
                    : "No"}
                </span>
              </div>
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {networkProfile.bandwidthRecommendations.useAggressiveCaching
                    ? "Yes"
                    : "No"}
                </span>
              </div>
              ...
              <div className="recommendation-item">
                ...
                <span className="recommendation-value">
                  {networkProfile.bandwidthRecommendations.lazyLoadNonCritical
                    ? "Yes"
                    : "No"}
                </span>
              </div>
            ...
            <div className="network-comparison">
              ...
              <div className="network-bar-chart">
                {southAfricanNetworkProfiles
                  .filter(
                    (p) => p.networkType !== "Fiber" && p.networkType !== "5G",
                  )
                  .sort((a, b) => b.downloadSpeedMbps - a.downloadSpeedMbps)
                  .map((profile) => (
                    <div
                      key={`${profile.provider}_${profile.locationType}`}
                      className="network-bar-item"
                    >
                      <div className="bar-label">
                        {profile.provider} ({profile.locationType})
                      </div>
                      <div className="bar-container">
                        <div
                          className="bar"
                          style={{
                            ...
                            backgroundColor:
                              ...
                              profile.locationType ===
                                networkProfile.locationType
                                ? "#007AFF"
                                : "#E5E5EA",
                          }}
                        />
                        <span className="bar-value">
                          {profile.downloadSpeedMbps.toFixed(1)} Mbps
                        </span>
                      </div>
                    </div>
                  ))}
            ...
            <div className="data-saver-tips">
              <h4>
                Data Saving Tips for {networkProfile.provider} in{" "}
                {networkProfile.locationType} Areas
              </h4>
              <ul>
                {networkProfile.dataCostPerMBZAR > 0.05 ? (
                  <>
                    <li>
                      Implement aggressive data saving mode (text-only view)
                    </li>
                    <li>Limit or disable animations completely</li>
                    <li>
                      Implement offline-first functionality for critical
                      features
                    </li>
                  ...
                  <>
                    ...
                    <li>
                      Use optimized image formats (WebP) with proper sizing
                    </li>
                    <li>Keep animations lightweight and non-essential</li>
                    <li>
                      Implement caching strategies appropriate for this network
                    </li>
                  </>
                )}
              </ul>
