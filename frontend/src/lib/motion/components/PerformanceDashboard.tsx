...
export function PerformanceDashboard({
  ...
  const getPriorityColor = (priority: MetricPriority): string => {
    switch (priority) {
      ...
      case "high":
        return "rgb(240, 120, 20)";
      case "medium":
        return "rgb(20, 120, 220)";
      case "low":
  ...
  if (!isExpanded) {
    return (
      ...
      >
        ...
        <div>
          {getFilteredMetrics("animation").length} animations |{" "}
          {getFilteredMetrics("component").length} components
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
          ...
          <div style={{ padding: "12px" }}>
            <div style={{ marginBottom: "8px" }}>
              ...
              >
                ...
                <span
                  style={{
                    fontWeight: "bold",
                    color:
                      deviceCapabilities.cpuPerformance === "high"
                        ? "rgb(100, 220, 100)"
                        : deviceCapabilities.cpuPerformance === "medium"
                          ? "rgb(220, 220, 100)"
              ...
              >
                ...
                <span
                  style={{
                    fontWeight: "bold",
                    color:
                      deviceCapabilities.gpuTier === "high"
                        ? "rgb(100, 220, 100)"
                        : deviceCapabilities.gpuTier === "medium"
                          ? "rgb(220, 220, 100)"
              ...
              {deviceCapabilities.screenDimensions && (
                ...
                >
                  <span>Screen:</span>
                  <span style={{ fontWeight: "bold" }}>
                    {deviceCapabilities.screenDimensions.width} ×{" "}
                    {deviceCapabilities.screenDimensions.height} (DPR:{" "}
                    {deviceCapabilities.screenDimensions.dpr})
                  </span>
                </div>
              )}
            ...
            >
              ...
              <ul style={{ margin: "0", paddingLeft: "20px" }}>
                ...
                {deviceCapabilities.isHighResolutionScreen &&
                  deviceCapabilities.gpuTier !== "high" && (
                    <li style={{ marginBottom: "4px" }}>
                      High-DPI screen may impact performance with complex
                      animations
                    </li>
                  )}
      ...
      >
        Fluxori Performance Monitor | Last updated:{" "}
