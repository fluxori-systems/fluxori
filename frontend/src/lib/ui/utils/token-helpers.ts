 ...
 */
export function getIntentBackgroundColor(intent: Intent = 'default', variant: 'light' | 'filled' | 'default' = 'default'): string {
  if (variant === 'filled') {
...
export function getRadiusValue(radius: Radius = 'md'): string {
  switch (radius) {
    case 'none': return 'var(--radius-none)';
...
export function getSpacingValue(spacing: Spacing = 'md'): string {
  ...
  switch (spacing) {
    ...
    case '3xl': return 'var(--spacing-3xl)';
    case '4xl': return 'var(--spacing-4xl)';
...
export function getFontSizeValue(size: Size = 'md'): string {
  switch (size) {
    ...
    case '2xl': return 'var(--font-size-2xl)';
    case '3xl': return 'var(--font-size-3xl)';
    case '4xl': return 'var(--font-size-4xl)';
    case '5xl': return 'var(--font-size-5xl)';
    case '6xl': return 'var(--font-size-6xl)';
 ...
 */
export function getShadowValue(size: 'none' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' = 'md'): string {
  switch (size) {
    case 'none': return 'none';
    case 'xs': return 'var(--shadow-xs)';
