          ...
          <div className="flx-showcase-section">
            ...
            <Card>
              ...
              <Stack p="md">
                ...
                <Text preset="body1">
                  Body 1 - Main body text used for most content.
                </Text>
                <Text preset="body2">
                  Body 2 - Secondary body text used for descriptions and less
                  important content.
                </Text>
                <Text preset="body3">
                  Body 3 - Small text used for supplementary information.
                </Text>
                <Text preset="caption">
                  Caption - Used for captions, timestamps, and small print.
                </Text>
                <Text preset="label">
                  Label - Used for form labels and badges.
                </Text>
                <Text preset="overline">
                  OVERLINE - USED FOR SECTION HEADERS
                </Text>
                <Text preset="code">
                ...
                <Grid columns={3} gutter="md">
                  ...
                  <Grid.Col span={1}>
                    <Card animationType="shadow" title="Shadow Animation">
                      <div style={{ padding: "var(--spacing-md)" }}>
                        <Text>
                          Hover over this card to see the shadow grow.
                        </Text>
                      </div>
                    </Card>
                  </Grid.Col>
                  ...
                  <Grid.Col span={1}>
                    <Card animationType="tilt" title="Tilt Animation">
                      <div style={{ padding: "var(--spacing-md)" }}>
                        <Text>
                          Hover over this card to see it tilt slightly.
                        </Text>
                      </div>
                    </Card>
                  </Grid.Col>
            ...
            <Card>
              ...
              <div style={{ padding: "var(--spacing-md)" }}>
                <Stack gap="md">
                  ...
                  >
                    <Text>
                      Container sizes adjust responsive padding automatically
                    </Text>
                  </div>
                </Stack>
              </div>
