...
import { renderWithProviders, screen, fireEvent, waitFor, within } from '../../../../testing/utils/render';

// Mock the Button component to avoid React hooks that require service providers
vi.mock('../Button', () => ({
  Button: ({ children, variant, size, intent, loading, disabled, fullWidth, networkAware, onClick, ...rest }) => {
...
describe('Button Component', () => {
  ...
  test('handles click events', () => {
    const handleClick = createTypedMock();
