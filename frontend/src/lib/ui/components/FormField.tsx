        ...
        case "select":
          return (
            <Select
              ...
              nothingFoundMessage={
                shouldSimplify ? null : props.nothingFoundMessage
              } // Hide message on poor connections
              maxDropdownHeight={shouldSimplify ? 200 : 300} // Reduce dropdown height on poor connections
              dropdownPosition={
                shouldSimplify ? "bottom" : props.dropdownPosition || "bottom"
              }
              withinPortal={
                shouldSimplify
                  ? false
                  : props.withinPortal !== undefined
                    ? props.withinPortal
                    : true
              }
            />
