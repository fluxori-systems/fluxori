...
export interface GroupProps extends BaseComponentProps, AnimatableComponentProps {
...
export const Group = forwardRef<HTMLDivElement, GroupProps>(
  ({ 
    ...
    let gap = inputGap;
    if (typeof inputGap === 'string' && inputGap !== 'auto') {
      gap = getSpacingFromMantine(theme, inputGap as keyof SpacingScale, undefined);
    }
    ...
    if (networkAware && (connectionQuality.isDataSaver || connectionQuality.quality === 'poor')) {
