...
import {
  getColorFromMantine,
  getRadiusFromMantine,
  getShadowFromMantine,
} from "../../design-system/utils/mantine-theme-adapter";
...
export const Card = forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const shouldSimplify =
      networkAware &&
      (isDataSaver || networkQuality === "poor" || networkQuality === "low");
    ...
    const getVariantStyles = useCallback((): React.CSSProperties => {
      ...
      if (
        ...
        return {
          ...
          boxShadow: "none",
          border: withBorder
            ? `1px solid ${getColorFromMantine(theme, "border.default", "var(--border-default)")}`
            : undefined,
        };
      }
      ...
      switch (variant) {
        case "elevated":
          ...
          return {
            ...
            boxShadow: shouldSimplify
              ? "none"
              : getShadowFromMantine(theme, "md", undefined),
          };
        case "outlined":
        ...
        case "filled":
          ...
          return {
            ...
            boxShadow: shouldSimplify
              ? "none"
              : getShadowFromMantine(theme, "xs", undefined),
          };
        case "transparent":
          return {
    ...
    const getAnimationStyles = (): React.CSSProperties => {
      ...
      if (
        (isRuralSouthAfrican && saMarket.shouldReduceMotion) ||
    ...
    const cardStyles: React.CSSProperties = {
      ...
      boxShadow: shouldSimplify
        ? "none"
        : shadow
          ? getShadowFromMantine(theme, shadow, undefined)
          : undefined,
      transition: animated
        ? `all ${networkAnimationSpeed * 0.3}s ease-out`
        : undefined,
    ...
    if (
      ...
      return (
        ...
        >
          {title && (
            <div
              className="flx-card-title-simplified"
              style={{
