  ...
  const renderToolIcon = () => {
    ...
    const defaultIcon = (
      ...
      >
        ...
        />
        <path
          d="M12 12L15 15M12 12L9 9M12 12L9 15M12 12L15 9"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  return (
    <Card
      ...
      style={{
        ...
        padding:
          detailed || expanded ? "var(--spacing-md)" : "var(--spacing-sm)",
      ...
      <Group gap="sm" align="center" justify="space-between" wrap="nowrap">
        <Group gap="xs" wrap="nowrap">
          ...
          <Text fw={500} c="var(--text-primary)">
            {tool.name}
            {tool.count > 1 && (
              <span style={{ opacity: 0.7 }}> ({tool.count})</span>
            )}
          </Text>
        </Group>
