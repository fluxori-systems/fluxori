...
export function AgentInput({
  ...
  const [activeSuggestions, setActiveSuggestions] = useState<AgentSuggestion[]>(suggestions);
        ...
        {attachmentsEnabled && !simplifiedUI && (
          <button
            ...
            onClick={() => {
              ...
              setAttachments(prev => [...prev, { type: 'file', name: `File ${prev.length + 1}` }]);
            }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M21 14V18C21 19.1046 20.1046 20 19 20H5C3.89543 20 3 19.1046 3 18V6C3 4.89543 3.89543 4 5 4H9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M13 15L13 8C13 6.34315 14.3431 5 16 5V5C17.6569 5 19 6.34315 19 8V15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M17 15V10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M15 15V10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        )}
