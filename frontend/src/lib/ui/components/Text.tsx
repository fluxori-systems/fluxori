...
import {
  ...
  getFontSize,
  getSpacing,
} from "../../design-system/utils/tokens";
import {
  SouthAfricanMarketOptimizer,
  SAOptimizer,
} from "../../shared/components/SouthAfricanMarketOptimizer";
import {
  ...
  (
    ...
    const getLineHeight = (): number | string | undefined => {
      if (lh === undefined && preset) {
        ...
        if (presetStyles.lh) {
          ...
          return typography.lineHeights[
            presetStyles.lh as keyof typeof typography.lineHeights
          ];
        }
        return undefined;
      }
      ...
      if (lh) {
        ...
        return typeof lh === "string"
          ? typography.lineHeights[lh as keyof typeof typography.lineHeights] ||
              lh
          : lh;
      }
    ...
    const getLetterSpacing = (): string | undefined => {
      if (ls === undefined && preset) {
        ...
        if (presetStyles.ls) {
          ...
          return typography.letterSpacings[
            presetStyles.ls as keyof typeof typography.letterSpacings
          ];
        }
        return undefined;
      }
      ...
      if (ls) {
        ...
        return (
          typography.letterSpacings[
            ls as keyof typeof typography.letterSpacings
          ] || ls
        );
      }
    ...
    useComponentAnimation({
      ...
      properties: {
        ...
        opacity:
          animationType === "fade" || animationType === "slide" ? 0 : undefined,
      },
    });
    ...
    if (shouldSimplify && typeof optimizedFz === "string") {
      ...
      if (
        saSensitive &&
        saMarket.isRural &&
        ["5xl", "6xl", "4xl", "3xl"].includes(optimizedFz)
      ) {
      ...
      // General network optimization for large text
        ...
        (isDataSaver || networkQuality === "poor") &&
