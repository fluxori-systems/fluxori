...
export interface DashboardGridComponent
  ...
  Col: React.ForwardRefExoticComponent<
    DashboardGridColProps & React.RefAttributes<HTMLDivElement>
  >;
}
...
const DashboardGridBase = forwardRef<HTMLDivElement, DashboardGridProps>(
  (
    ...
    const { shouldReduceMotion, shouldUsePlaceholders } =
    ...
    return (
      <Grid
        ...
        style={{
          ...
          gap:
            typeof effectiveGap === "string"
              ? `var(--spacing-${effectiveGap})`
              : `${effectiveGap}px`,
          ...style,
        }}
...
export const DashboardGrid = Object.assign(DashboardGridBase, {
  Col,
}) as DashboardGridComponent;
