  ...
  ({ 
    ...
    const childrenWithProps = React.Children.map(children, child => {
      if (React.isValidElement(child)) {
        ...
        if (child.type && (child.type as any).displayName === 'DashboardSection') {
      ...
      >
        ...
        {showDensityControls && (
          ...
          >
            ...
            {!(networkAware && (quality === 'poor' || isDataSaver) && shouldReduceDataUsage) && (
              <Button 
                variant="light"
                size="sm"
                ...
                disabled={networkAware && (quality === 'poor' || isDataSaver) && shouldReduceDataUsage}
              >
        ...
        <div 
          ...
          style={{
            ...
            gap: density === 'compact' ? 'var(--spacing-md)' : 'var(--spacing-lg)'
          }}
        >
          {childrenWithProps}
        </div>
