 ...
 */
export type Intent = 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'info' | 'neutral' | 'default';
 ...
 */
export type AnimationType = 'none' | 'scale' | 'fade' | 'slide' | 'ripple' | 'bounce' | 'pulse' | 'hover' | 'shadow' | 'tilt';

/**
 * Standard spacing types (based on design system tokens)
 */
export type Spacing = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | 'auto' | number;
