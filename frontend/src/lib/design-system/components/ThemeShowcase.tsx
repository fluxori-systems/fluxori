...
export function ThemeShowcase() {
  ...
  return (
    <Box p="xl">
      ...
      <Paper p="md" mb="xl">
        <Text>
          This showcase demonstrates the design tokens used throughout the
          Fluxori application. The design system provides consistent styling,
          ...
          {["success", "warning", "error", "info"].map((semantic) => (
            <Grid.Col span={3} key={semantic}>
              <Paper withBorder p="sm" mb="md">
                <Text fw={700} tt="capitalize" mb="xs">
                  {semantic}
                </Text>
                <Grid>
                  {Object.entries(colors[semantic as keyof typeof colors]).map(
                    ([variant, value]) => (
                          ...
                          style={{
                            ...
                            color:
                              variant === "contrast"
                                ? (
                                    colors[
                                      semantic as keyof typeof colors
                                    ] as any
                                  ).base
                                : (
                                    colors[
        ...
        <Grid>
          {Object.entries(shadows).map(([name, value]) => (
            <Grid.Col span={3} key={name}>
              ...
              <Text size="xs" tt="capitalize" mb="md">
                {name}
              </Text>
