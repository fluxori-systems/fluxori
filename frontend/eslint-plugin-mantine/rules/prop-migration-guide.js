...
const PROP_DOCUMENTATION = {
  ...
  justify:
    'Horizontal alignment: "flex-start", "center", "flex-end", "space-between", etc.',
  leftSection:
    "Content to display on the left side of a component (usually an icon)",
  rightSection:
    "Content to display on the right side of a component (usually an icon)",
...
const MIGRATION_EXAMPLES = [
  {
    component: "Text",
    before:
      '<Text weight="bold" align="center" color="blue.5">Hello world</Text>',
...
module.exports = {
  ...
  meta: {
    ...
    docs: {
      description:
        "Detects deprecated Mantine props and suggests modern alternatives",
