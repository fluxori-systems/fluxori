...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      severity: "error",
      comment:
        "UI components should not directly import from Motion module - use shared interfaces instead",
      from: {
        path: ["^src/lib/ui/"],
        pathNot: [".d.ts$"],
      },
    ...
    },
    {
      ...
      severity: "error",
      comment:
        "Motion components should not directly import from UI module - use shared interfaces instead",
      from: {
        path: ["^src/lib/motion/"],
        pathNot: [".d.ts$"],
      },
    ...
    },
    {
      ...
      severity: "error",
      comment:
        "Firebase should only be imported through the firebase utility layer",
      from: {
        pathNot: ["^src/lib/firebase"],
      },
      to: {
  ...
  options: {
    doNotFollow: {
      path: ["node_modules", "\\.(css|scss|sass|less|styl|html|gql|graphql)$"],
      dependencyTypes: [
        "npm",
        "npm-dev",
        "npm-optional",
